...
public class SystemGroupsApiTest {
    ...
    private static SystemGroupsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new SystemGroupsApi(apiClient);
    }
     ...
     */
    @Test
    public void applySuggestionsTest() throws ApiException {
        String groupId = null;
        List<String> objectIds = null;
        String xOrgId = null;
        Object response = api.applySuggestions(groupId)
                .objectIds(objectIds)
                .xOrgId(xOrgId)
                .execute();
    ...
    public void createNewGroupTest() throws ApiException {
        ...
        List<GraphObject> memberQueryExemptions = null;
        Boolean memberSuggestionsNotify = null;
        GroupMembershipMethodType membershipMethod = null;
        String xOrgId = null;
        SystemGroup response = api.createNewGroup(name)
    ...
    public void deleteGroupTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        SystemGroup response = api.deleteGroup(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listAllTest() throws ApiException {
        ...
        String xOrgId = null;
        List<SystemGroup> response = api.listAll()
                .fields(fields)
                .filter(filter)
                .limit(limit)
                .skip(skip)
     ...
     */
    @Test
    public void listSuggestionsTest() throws ApiException {
        String groupId = null;
        String xOrgId = null;
        Integer limit = null;
        Integer skip = null;
        List<MemberSuggestion> response = api.listSuggestions(groupId)
                .xOrgId(xOrgId)
                .limit(limit)
                .skip(skip)
                .execute();
    ...
    public void updateGroupTest() throws ApiException {
        ...
        GroupMembershipMethodType membershipMethod = null;
        String xOrgId = null;
        SystemGroup response = api.updateGroup(name, id)
                .description(description)
                .attributes(attributes)
                .email(email)
                .memberQuery(memberQuery)
     ...
     */
    @Test
    public void viewDetailsTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        SystemGroup response = api.viewDetails(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
