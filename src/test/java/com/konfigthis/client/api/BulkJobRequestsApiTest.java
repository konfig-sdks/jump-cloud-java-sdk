...
public class BulkJobRequestsApiTest {
    ...
    private static BulkJobRequestsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new BulkJobRequestsApi(apiClient);
    }
     ...
     */
    @Test
    public void userExpiresTest() throws ApiException {
        String xOrgId = null;
        JobId response = api.userExpires()
                .xOrgId(xOrgId)
                .execute();
     ...
     */
    @Test
    public void userStatesCreateTest() throws ApiException {
        OffsetDateTime startDate = null;
        String state = null;
        List<String> userIds = null;
        String activationEmailOverride = null;
        Boolean sendActivationEmails = null;
        String xOrgId = null;
        List<ScheduledUserstateResult> response = api.userStatesCreate(startDate, state, userIds)
     ...
     */
    @Test
    public void userStatesDeleteTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        api.userStatesDelete(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void userStatesGetNextScheduledTest() throws ApiException {
        List<String> users = null;
        Integer limit = null;
        Integer skip = null;
        BulkUserStatesGetNextScheduledResponse response = api.userStatesGetNextScheduled(users)
                .limit(limit)
                .skip(skip)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void userStatesListTest() throws ApiException {
        Integer limit = null;
        List<String> filter = null;
        Integer skip = null;
        String xOrgId = null;
        String userid = null;
        List<ScheduledUserstateResult> response = api.userStatesList()
                .limit(limit)
                .filter(filter)
                .skip(skip)
                .xOrgId(xOrgId)
     ...
     */
    @Test
    public void userUnlocksTest() throws ApiException {
        String xOrgId = null;
        JobId response = api.userUnlocks()
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void usersCreateTest() throws ApiException {
        ...
        JobId response = api.usersCreate()
                .xOrgId(xOrgId)
     ...
     */
    @Test
    public void usersCreateResultsTest() throws ApiException {
        String jobId = null;
        Integer limit = null;
        Integer skip = null;
        String xOrgId = null;
        List<JobWorkresult> response = api.usersCreateResults(jobId)
                .limit(limit)
                .skip(skip)
                .xOrgId(xOrgId)
                .execute();
    ...
    public void usersUpdateTest() throws ApiException {
        String xOrgId = null;
        JobId response = api.usersUpdate()
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
