...
|------------- | ------------- | -------------|
| [**cancelQueuedCommandsByWorkflowInstanceId**](CommandsApi.md#cancelQueuedCommandsByWorkflowInstanceId) | **DELETE** /commandqueue/{workflow_instance_id} | Cancel all queued commands for an organization by workflow instance Id |
| [**commandAssociationsList**](CommandsApi.md#commandAssociationsList) | **GET** /commands/{command_id}/associations | List the associations of a Command |
| [**commandAssociationsPost**](CommandsApi.md#commandAssociationsPost) | **POST** /commands/{command_id}/associations | Manage the associations of a Command |
| [**commandTraverseSystem**](CommandsApi.md#commandTraverseSystem) | **GET** /commands/{command_id}/systems | List the Systems bound to a Command |
| [**commandTraverseSystemGroup**](CommandsApi.md#commandTraverseSystemGroup) | **GET** /commands/{command_id}/systemgroups | List the System Groups bound to a Command |
| [**getQueuedCommandsByWorkflow**](CommandsApi.md#getQueuedCommandsByWorkflow) | **GET** /queuedcommand/workflows | Fetch the queued Commands for an Organization |


<a name="cancelQueuedCommandsByWorkflowInstanceId"></a>
# **cancelQueuedCommandsByWorkflowInstanceId**
> cancelQueuedCommandsByWorkflowInstanceId(workflowInstanceId).xOrgId(xOrgId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String workflowInstanceId = "workflowInstanceId_example"; // Workflow instance Id of the queued commands to cancel.
    String xOrgId = "xOrgId_example"; // Organization identifier that can be obtained from console settings.
    try {
      client
              .commands
              .cancelQueuedCommandsByWorkflowInstanceId(workflowInstanceId)
              .xOrgId(xOrgId)
              .execute();
    } catch (ApiException e) {
      System.err.println("Exception when calling CommandsApi#cancelQueuedCommandsByWorkflowInstanceId");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling CommandsApi#commandAssociationsList");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling CommandsApi#commandAssociationsPost");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling CommandsApi#commandTraverseSystem");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling CommandsApi#commandTraverseSystemGroup");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getQueuedCommandsByWorkflow"></a>
# **getQueuedCommandsByWorkflow**
> QueuedCommandList getQueuedCommandsByWorkflow().xOrgId(xOrgId).limit(limit).filter(filter).skip(skip).sort(sort).search(search).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String search = ""; // The search string to query records
    try {
      QueuedCommandList result = client
              .commands
              .getQueuedCommandsByWorkflow()
              .xOrgId(xOrgId)
              .limit(limit)
      ...
      System.err.println("Exception when calling CommandsApi#getQueuedCommandsByWorkflow");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<QueuedCommandList> response = client
              .commands
              .getQueuedCommandsByWorkflow()
              .xOrgId(xOrgId)
              .limit(limit)
...
| **search** | **String**| The search string to query records | [optional] [default to ] |
