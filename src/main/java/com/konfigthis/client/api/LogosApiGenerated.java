...
public class LogosApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public LogosApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public LogosApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private ApiResponse<File> getWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAsync(String id, final ApiCallback<File> _callback) throws ApiException {
    ...
    public class GetRequestBuilder {
        ...
        public File execute() throws ApiException {
            ApiResponse<File> localVarResp = getWithHttpInfo(id);
