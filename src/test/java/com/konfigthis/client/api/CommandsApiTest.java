...
public class CommandsApiTest {
    ...
    private static CommandsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new CommandsApi(apiClient);
    }
     ...
     */
    @Test
    public void cancelQueuedCommandsByWorkflowInstanceIdTest() throws ApiException {
        String workflowInstanceId = null;
        String xOrgId = null;
        api.cancelQueuedCommandsByWorkflowInstanceId(workflowInstanceId)
                .xOrgId(xOrgId)
                .execute();
     ...
     */
    @Test
    public void getQueuedCommandsByWorkflowTest() throws ApiException {
        String xOrgId = null;
        Integer limit = null;
        List<String> filter = null;
        Integer skip = null;
        ...
        String search = null;
        QueuedCommandList response = api.getQueuedCommandsByWorkflow()
                .xOrgId(xOrgId)
                .limit(limit)
                .filter(filter)
                .skip(skip)
