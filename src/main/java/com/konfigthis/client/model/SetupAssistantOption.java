 ...
 */
@JsonAdapter(SetupAssistantOption.Adapter.class)public enum SetupAssistantOption {
  ...
  public static SetupAssistantOption fromValue(String value) {
  ...
  public static class Adapter extends TypeAdapter<SetupAssistantOption> {
    ...
    public SetupAssistantOption read(final JsonReader jsonReader) throws IOException {
      ...
      return SetupAssistantOption.fromValue(value);
    }
  }
}
