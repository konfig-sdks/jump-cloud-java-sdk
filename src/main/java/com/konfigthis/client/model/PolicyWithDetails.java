...
import com.konfigthis.client.model.PolicyTemplateConfigField;
 ...
 */
@ApiModel(description = "An instance of a policy template.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PolicyWithDetails {
  ...
  **/
  ...
  public PolicyWithDetails notes(String notes) {
  ...
  **/
   ...
   * @return the PolicyWithDetails instance itself
   */
  public PolicyWithDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.configFields, policyWithDetails.configFields) &&
        ...
        Objects.equals(this.notes, policyWithDetails.notes) &&
        Objects.equals(this.template, policyWithDetails.template) &&
        Objects.equals(this.values, policyWithDetails.values)&&
        Objects.equals(this.additionalProperties, policyWithDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configFields, id, name, notes, template, values, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PolicyWithDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PolicyWithDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyWithDetails is not found in the empty JSON string", PolicyWithDetails.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("configFields") != null && !jsonObj.get("configFields").isJsonNull()) {
        ...
        if (jsonArrayconfigFields != null) {
          ...
          for (int i = 0; i < jsonArrayconfigFields.size(); i++) {
            PolicyTemplateConfigField.validateJsonObject(jsonArrayconfigFields.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("template") != null && !jsonObj.get("template").isJsonNull()) {
        PolicyTemplate.validateJsonObject(jsonObj.getAsJsonObject("template"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyWithDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyWithDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyWithDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyWithDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyWithDetails>() {
           @Override
           public void write(JsonWriter out, PolicyWithDetails value) throws IOException {
           ...
           @Override
           public PolicyWithDetails read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PolicyWithDetails instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PolicyWithDetails given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PolicyWithDetails
  * @throws IOException if the JSON string is invalid with respect to PolicyWithDetails
  */
  public static PolicyWithDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyWithDetails.class);
  }

 /**
  * Convert an instance of PolicyWithDetails to an JSON string
  *
  * @return JSON string
  */
