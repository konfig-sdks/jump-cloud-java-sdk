 ...
 * Basic query.
 */
@ApiModel(description = "Basic query.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Query {
  /**
  ...
  **/
  ...
  @ApiModelProperty(example = "FILTERQUERY", required = true, value = "")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(queryType, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      String discriminatorValue = jsonObj.get("queryType").getAsString();
      switch (discriminatorValue) {
        case "MemberQuery":
          MemberQuery.validateJsonObject(jsonObj);
          break;
        default: 
          throw new IllegalArgumentException(String.format("The value of the `queryType` field `%s` does not match any key defined in the discriminator's mapping.", discriminatorValue));
      }
  }
