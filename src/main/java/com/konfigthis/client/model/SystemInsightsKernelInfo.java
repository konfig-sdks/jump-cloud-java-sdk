...
public class SystemInsightsKernelInfo {
  ...
  **/
   ...
   * @return the SystemInsightsKernelInfo instance itself
   */
  public SystemInsightsKernelInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, systemInsightsKernelInfo.version) &&
        Objects.equals(this.arguments, systemInsightsKernelInfo.arguments) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsKernelInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, arguments, collectionTime, device, path, systemId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsKernelInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsKernelInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsKernelInfo is not found in the empty JSON string", SystemInsightsKernelInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsKernelInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsKernelInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsKernelInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsKernelInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsKernelInfo>() {
           @Override
           public void write(JsonWriter out, SystemInsightsKernelInfo value) throws IOException {
           ...
           @Override
           public SystemInsightsKernelInfo read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsKernelInfo instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsKernelInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsKernelInfo
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsKernelInfo
  */
  public static SystemInsightsKernelInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsKernelInfo.class);
  }

 /**
  * Convert an instance of SystemInsightsKernelInfo to an JSON string
  *
  * @return JSON string
  */
