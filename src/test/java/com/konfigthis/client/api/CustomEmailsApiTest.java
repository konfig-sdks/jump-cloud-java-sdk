...
public class CustomEmailsApiTest {
    ...
    private static CustomEmailsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new CustomEmailsApi(apiClient);
    }
    ...
    public void createTest() throws ApiException {
        String subject = null;
        CustomEmailType type = null;
        String title = null;
        String body = null;
        String button = null;
        String header = null;
        String id = null;
        String nextStepContactInfo = null;
        String xOrgId = null;
        CustomEmail response = api.create(subject, type)
                .title(title)
                .body(body)
                .button(button)
                .header(header)
    ...
    public void getTemplatesTest() throws ApiException {
        List<CustomEmailTemplate> response = api.getTemplates()
                .execute();
        // TODO: test validations
    }
    ...
    public void readTest() throws ApiException {
        String customEmailType = null;
        String xOrgId = null;
        CustomEmail response = api.read(customEmailType)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateTest() throws ApiException {
        ...
        String nextStepContactInfo = null;
        String xOrgId = null;
        CustomEmail response = api.update(subject, type, customEmailType)
                .title(title)
                .body(body)
                .button(button)
                .header(header)
