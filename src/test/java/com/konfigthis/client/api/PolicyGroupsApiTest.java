...
public class PolicyGroupsApiTest {
    ...
    private static PolicyGroupsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PolicyGroupsApi(apiClient);
    }
    ...
    public void createNewTest() throws ApiException {
        String name = null;
        String xOrgId = null;
        PolicyGroup response = api.createNew(name)
                .xOrgId(xOrgId)
                .execute();
    ...
    public void deleteGroupTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        PolicyGroup response = api.deleteGroup(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getDetailsTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        PolicyGroup response = api.getDetails(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listAllTest() throws ApiException {
        ...
        String xOrgId = null;
        List<PolicyGroup> response = api.listAll()
                .fields(fields)
                .filter(filter)
                .limit(limit)
                .skip(skip)
     ...
     */
    @Test
    public void updatePolicyGroupTest() throws ApiException {
        String name = null;
        String id = null;
        String xOrgId = null;
        PolicyGroup response = api.updatePolicyGroup(name, id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
