...
public class SystemInsightsUsbDevices {
  ...
  public static final String SERIALIZED_NAME_USB_ADDRESS = "usb_address";
  @SerializedName(SERIALIZED_NAME_USB_ADDRESS)
  private Integer usbAddress;

  public static final String SERIALIZED_NAME_USB_PORT = "usb_port";
  @SerializedName(SERIALIZED_NAME_USB_PORT)
  ...
  **/
   ...
   * @return the SystemInsightsUsbDevices instance itself
   */
  public SystemInsightsUsbDevices putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, systemInsightsUsbDevices.version) &&
        Objects.equals(this.propertyClass, systemInsightsUsbDevices.propertyClass) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsUsbDevices.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, propertyClass, collectionTime, model, modelId, protocol, removable, serial, subclass, systemId, usbAddress, usbPort, vendor, vendorId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("usb_address");
    openapiFields.add("usb_port");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsUsbDevices
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsUsbDevices.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsUsbDevices is not found in the empty JSON string", SystemInsightsUsbDevices.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("subclass") != null && !jsonObj.get("subclass").isJsonNull()) && !jsonObj.get("subclass").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `subclass` to be a primitive type in the JSON string but got `%s`", jsonObj.get("subclass").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsUsbDevices.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsUsbDevices' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsUsbDevices> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsUsbDevices.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsUsbDevices>() {
           @Override
           public void write(JsonWriter out, SystemInsightsUsbDevices value) throws IOException {
           ...
           @Override
           public SystemInsightsUsbDevices read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsUsbDevices instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsUsbDevices given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsUsbDevices
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsUsbDevices
  */
  public static SystemInsightsUsbDevices fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsUsbDevices.class);
  }

 /**
  * Convert an instance of SystemInsightsUsbDevices to an JSON string
  *
  * @return JSON string
  */
