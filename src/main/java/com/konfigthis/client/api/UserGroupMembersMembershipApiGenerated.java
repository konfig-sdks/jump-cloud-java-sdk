...
public class UserGroupMembersMembershipApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public UserGroupMembersMembershipApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public UserGroupMembersMembershipApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
