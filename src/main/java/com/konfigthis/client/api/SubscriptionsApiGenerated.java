...
public class SubscriptionsApiGenerated {
    ...
    private ApiResponse<List<Subscription>> getWithHttpInfo() throws ApiException {
    ...
    private okhttp3.Call getAsync(final ApiCallback<List<Subscription>> _callback) throws ApiException {
    ...
    public class GetRequestBuilder {
        ...
        public List<Subscription> execute() throws ApiException {
            ApiResponse<List<Subscription>> localVarResp = getWithHttpInfo();
