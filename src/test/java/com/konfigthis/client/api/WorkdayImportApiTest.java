...
public class WorkdayImportApiTest {
    ...
    private static WorkdayImportApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new WorkdayImportApi(apiClient);
    }
    ...
    public void callImportTest() throws ApiException {
        String workdayId = null;
        String xOrgId = null;
        JobId response = api.callImport(workdayId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        WorkdayOutput response = api.get(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void importresultsTest() throws ApiException {
        String id = null;
        String jobId = null;
        Integer limit = null;
        Integer skip = null;
        String xOrgId = null;
        List<JobWorkresult> response = api.importresults(id, jobId)
                .limit(limit)
                .skip(skip)
                .xOrgId(xOrgId)
                .execute();
    ...
    public void listTest() throws ApiException {
        ...
        String xOrgId = null;
        List<WorkdayOutput> response = api.list()
                .fields(fields)
                .limit(limit)
                .skip(skip)
                .sort(sort)
    ...
    public void postTest() throws ApiException {
        ...
        String xOrgId = null;
        WorkdayOutput response = api.post()
                .auth(auth)
                .name(name)
                .reportUrl(reportUrl)
                .xOrgId(xOrgId)
    ...
    public void putTest() throws ApiException {
        ...
        String reportUrl = null;
        String xOrgId = null;
        WorkdayOutput response = api.put(id)
                .name(name)
                .reportUrl(reportUrl)
                .xOrgId(xOrgId)
                .execute();
     ...
     */
    @Test
    public void workersTest() throws ApiException {
        String workdayId = null;
        Integer limit = null;
        Integer skip = null;
        List<String> sort = null;
        String xOrgId = null;
        List<WorkdayWorker> response = api.workers(workdayId)
                .limit(limit)
                .skip(skip)
                .sort(sort)
                .xOrgId(xOrgId)
