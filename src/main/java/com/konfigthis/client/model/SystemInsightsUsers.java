...
public class SystemInsightsUsers {
  ...
  public static final String SERIALIZED_NAME_AD_MANAGED = "ad_managed";
  @SerializedName(SERIALIZED_NAME_AD_MANAGED)
  private Boolean adManaged;
  ...
  public static final String SERIALIZED_NAME_GID_SIGNED = "gid_signed";
  @SerializedName(SERIALIZED_NAME_GID_SIGNED)
  private String gidSigned;
  ...
  public static final String SERIALIZED_NAME_REAL_USER = "real_user";
  @SerializedName(SERIALIZED_NAME_REAL_USER)
  ...
  public static final String SERIALIZED_NAME_UID_SIGNED = "uid_signed";
  @SerializedName(SERIALIZED_NAME_UID_SIGNED)
  private String uidSigned;
  ...
  **/
  ...
  @ApiModelProperty(example = "AppleEvents Daemon", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates this account belongs to a AD-managed user")

  public Boolean getAdManaged() {
    return adManaged;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates this account has local administrator privileges")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2019-06-03T19:41:29.710Z", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "/var/empty", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A Unix timestamp showing the last time this user logged in")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates this account belongs to a JumpCloud-managed user")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates this account represents an interactive user account vs. a system or daemon account")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "/usr/bin/false", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates this account is suspended or locked out")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "_appleevents", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "FFFFEEEE-DDDD-CCCC-BBBB-AAAA00000037", value = "")
   ...
   * @return the SystemInsightsUsers instance itself
   */
  public SystemInsightsUsers putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, systemInsightsUsers.description) &&
        Objects.equals(this.adManaged, systemInsightsUsers.adManaged) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsUsers.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, adManaged, admin, collectionTime, directory, gid, gidSigned, lastLogin, managed, realUser, shell, suspended, systemId, type, uid, uidSigned, username, uuid, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsUsers
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsUsers.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsUsers is not found in the empty JSON string", SystemInsightsUsers.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("gid_signed") != null && !jsonObj.get("gid_signed").isJsonNull()) && !jsonObj.get("gid_signed").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `gid_signed` to be a primitive type in the JSON string but got `%s`", jsonObj.get("gid_signed").toString()));
      }
      ...
      if ((jsonObj.get("uid_signed") != null && !jsonObj.get("uid_signed").isJsonNull()) && !jsonObj.get("uid_signed").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `uid_signed` to be a primitive type in the JSON string but got `%s`", jsonObj.get("uid_signed").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsUsers.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsUsers' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsUsers> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsUsers.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsUsers>() {
           @Override
           public void write(JsonWriter out, SystemInsightsUsers value) throws IOException {
           ...
           @Override
           public SystemInsightsUsers read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsUsers instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsUsers given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsUsers
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsUsers
  */
  public static SystemInsightsUsers fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsUsers.class);
  }

 /**
  * Convert an instance of SystemInsightsUsers to an JSON string
  *
  * @return JSON string
  */
