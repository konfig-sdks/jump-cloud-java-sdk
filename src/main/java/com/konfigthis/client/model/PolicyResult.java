...
public class PolicyResult {
  ...
  **/
   ...
   * @return the PolicyResult instance itself
   */
  public PolicyResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.detail, policyResult.detail) &&
        ...
        Objects.equals(this.additionalProperties, policyResult.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(detail, endedAt, exitStatus, id, policyID, startedAt, state, stdErr, stdOut, success, systemID, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PolicyResult
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PolicyResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyResult is not found in the empty JSON string", PolicyResult.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyResult.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyResult>() {
           @Override
           public void write(JsonWriter out, PolicyResult value) throws IOException {
           ...
           @Override
           public PolicyResult read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PolicyResult instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PolicyResult given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PolicyResult
  * @throws IOException if the JSON string is invalid with respect to PolicyResult
  */
  public static PolicyResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyResult.class);
  }

 /**
  * Convert an instance of PolicyResult to an JSON string
  *
  * @return JSON string
  */
