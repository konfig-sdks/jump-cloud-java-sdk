...
public class ActiveDirectory {
  ...
  public static final String SERIALIZED_NAME_PRIMARY_AGENT = "primaryAgent";
  @SerializedName(SERIALIZED_NAME_PRIMARY_AGENT)
  private String primaryAgent;

  /**
   * Gets or Sets useCase
   */
  @JsonAdapter(UseCaseEnum.Adapter.class)
 public enum UseCaseEnum {
    ...
    public static class Adapter extends TypeAdapter<UseCaseEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final UseCaseEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public UseCaseEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return UseCaseEnum.fromValue(value);
      }
    }
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ObjectID of this Active Directory instance.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ObjectID of the primary agent of domain.")
  ...
  public ActiveDirectory useCase(UseCaseEnum useCase) {
  ...
  **/
   ...
   * @return the ActiveDirectory instance itself
   */
  public ActiveDirectory putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domain, activeDirectory.domain) &&
        Objects.equals(this.id, activeDirectory.id) &&
        Objects.equals(this.primaryAgent, activeDirectory.primaryAgent) &&
        Objects.equals(this.useCase, activeDirectory.useCase)&&
        Objects.equals(this.additionalProperties, activeDirectory.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, id, primaryAgent, useCase, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    primaryAgent: ").append(toIndentedString(primaryAgent)).append("\n");
  ...
  static {
    ...
    openapiFields.add("primaryAgent");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActiveDirectory
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActiveDirectory.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if ((jsonObj.get("primaryAgent") != null && !jsonObj.get("primaryAgent").isJsonNull()) && !jsonObj.get("primaryAgent").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `primaryAgent` to be a primitive type in the JSON string but got `%s`", jsonObj.get("primaryAgent").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ActiveDirectory>() {
           ...
           public ActiveDirectory read(JsonReader in) throws IOException {
             ...
             ActiveDirectory instance = thisAdapter.fromJsonTree(jsonObj);
