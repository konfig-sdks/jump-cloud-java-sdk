...
import com.konfigthis.client.model.AuthnPolicy;
import com.konfigthis.client.model.AuthnPolicyEffect;
import com.konfigthis.client.model.AuthnPolicyTargets;
import com.konfigthis.client.model.AuthnPolicyType;
...
public class AuthenticationPoliciesApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AuthenticationPoliciesApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public AuthenticationPoliciesApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private ApiResponse<AuthnPolicy> deleteWithHttpInfo(String id, String xOrgId) throws ApiException {
    ...
    private okhttp3.Call deleteAsync(String id, String xOrgId, final ApiCallback<AuthnPolicy> _callback) throws ApiException {
    ...
    public class DeleteRequestBuilder {
         ...
         */
        public AuthnPolicy execute() throws ApiException {
            ApiResponse<AuthnPolicy> localVarResp = deleteWithHttpInfo(id, xOrgId);
         ...
         */
        public ApiResponse<AuthnPolicy> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<AuthnPolicy> _callback) throws ApiException {
    ...
    private ApiResponse<AuthnPolicy> getWithHttpInfo(String id, String xOrgId) throws ApiException {
        okhttp3.Call localVarCall = getValidateBeforeCall(id, xOrgId, null);
        Type localVarReturnType = new TypeToken<AuthnPolicy>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAsync(String id, String xOrgId, final ApiCallback<AuthnPolicy> _callback) throws ApiException {
    ...
    public class GetRequestBuilder {
         ...
         */
        public AuthnPolicy execute() throws ApiException {
            ApiResponse<AuthnPolicy> localVarResp = getWithHttpInfo(id, xOrgId);
            return localVarResp.getResponseBody();
        }
    ...
    private ApiResponse<List<AuthnPolicy>> listWithHttpInfo(String xOrgId, Integer xTotalCount, Integer limit, Integer skip, List<String> filter, List<String> sort) throws ApiException {
    ...
    private okhttp3.Call listAsync(String xOrgId, Integer xTotalCount, Integer limit, Integer skip, List<String> filter, List<String> sort, final ApiCallback<List<AuthnPolicy>> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
         ...
         */
        public List<AuthnPolicy> execute() throws ApiException {
            ApiResponse<List<AuthnPolicy>> localVarResp = listWithHttpInfo(xOrgId, xTotalCount, limit, skip, filter, sort);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<List<AuthnPolicy>> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<AuthnPolicy>> _callback) throws ApiException {
    ...
    private okhttp3.Call patchCall(String id, String xOrgId, AuthnPolicy authnPolicy, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = authnPolicy;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchValidateBeforeCall(String id, String xOrgId, AuthnPolicy authnPolicy, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling patch(Async)");
        }

        return patchCall(id, xOrgId, authnPolicy, _callback);

    }


    private ApiResponse<AuthnPolicy> patchWithHttpInfo(String id, String xOrgId, AuthnPolicy authnPolicy) throws ApiException {
        okhttp3.Call localVarCall = patchValidateBeforeCall(id, xOrgId, authnPolicy, null);
        Type localVarReturnType = new TypeToken<AuthnPolicy>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call patchAsync(String id, String xOrgId, AuthnPolicy authnPolicy, final ApiCallback<AuthnPolicy> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchValidateBeforeCall(id, xOrgId, authnPolicy, _callback);
        Type localVarReturnType = new TypeToken<AuthnPolicy>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class PatchRequestBuilder {
        ...
        private AuthnPolicyEffect effect;
        private String id;
        private String name;
        private AuthnPolicyTargets targets;
        private AuthnPolicyType type;
        private String xOrgId;
         ...
         * @return PatchRequestBuilder
         */
        public PatchRequestBuilder disabled(Boolean disabled) {
        ...
        /**
         * Set effect
         * @param effect  (optional)
         * @return PatchRequestBuilder
         */
        public PatchRequestBuilder effect(AuthnPolicyEffect effect) {
            this.effect = effect;
            return this;
        }
         ...
         * @return PatchRequestBuilder
         */
        public PatchRequestBuilder targets(AuthnPolicyTargets targets) {
        ...
        /**
         * Set type
         * @param type  (optional, default to user_portal)
         * @return PatchRequestBuilder
         */
        public PatchRequestBuilder type(AuthnPolicyType type) {
            this.type = type;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            AuthnPolicy authnPolicy = buildBodyParams();
            return patchCall(id, xOrgId, authnPolicy, _callback);
        }

        private AuthnPolicy buildBodyParams() {
            AuthnPolicy authnPolicy = new AuthnPolicy();
            authnPolicy.description(this.description);
            authnPolicy.conditions(this.conditions);
            authnPolicy.disabled(this.disabled);
            authnPolicy.effect(this.effect);
            authnPolicy.id(this.id);
            authnPolicy.name(this.name);
            authnPolicy.targets(this.targets);
            authnPolicy.type(this.type);
            return authnPolicy;
        }
        ...
        public AuthnPolicy execute() throws ApiException {
            AuthnPolicy authnPolicy = buildBodyParams();
            ApiResponse<AuthnPolicy> localVarResp = patchWithHttpInfo(id, xOrgId, authnPolicy);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<AuthnPolicy> executeWithHttpInfo() throws ApiException {
            AuthnPolicy authnPolicy = buildBodyParams();
            return patchWithHttpInfo(id, xOrgId, authnPolicy);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<AuthnPolicy> _callback) throws ApiException {
            AuthnPolicy authnPolicy = buildBodyParams();
            return patchAsync(id, xOrgId, authnPolicy, _callback);
        }
    }
    ...
    private okhttp3.Call postCall(String xOrgId, AuthnPolicy authnPolicy, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postValidateBeforeCall(String xOrgId, AuthnPolicy authnPolicy, final ApiCallback _callback) throws ApiException {
        return postCall(xOrgId, authnPolicy, _callback);

    }


    private ApiResponse<AuthnPolicy> postWithHttpInfo(String xOrgId, AuthnPolicy authnPolicy) throws ApiException {
        okhttp3.Call localVarCall = postValidateBeforeCall(xOrgId, authnPolicy, null);
        Type localVarReturnType = new TypeToken<AuthnPolicy>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call postAsync(String xOrgId, AuthnPolicy authnPolicy, final ApiCallback<AuthnPolicy> _callback) throws ApiException {

        okhttp3.Call localVarCall = postValidateBeforeCall(xOrgId, authnPolicy, _callback);
        Type localVarReturnType = new TypeToken<AuthnPolicy>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class PostRequestBuilder {
         ...
         * @return PostRequestBuilder
         */
        public PostRequestBuilder conditions(Object conditions) {
            this.conditions = conditions;
            return this;
        }
         ...
         * @return PostRequestBuilder
         */
        public PostRequestBuilder disabled(Boolean disabled) {
            this.disabled = disabled;
            return this;
        }
         ...
         * @return PostRequestBuilder
         */
        public PostRequestBuilder effect(AuthnPolicyEffect effect) {
            this.effect = effect;
            return this;
        }
         ...
         * @return PostRequestBuilder
         */
        public PostRequestBuilder targets(AuthnPolicyTargets targets) {
            this.targets = targets;
            return this;
        }
         ...
         * @return PostRequestBuilder
         */
        public PostRequestBuilder type(AuthnPolicyType type) {
            this.type = type;
            return this;
        }
        ...
        public AuthnPolicy execute() throws ApiException {
            AuthnPolicy authnPolicy = buildBodyParams();
            ApiResponse<AuthnPolicy> localVarResp = postWithHttpInfo(xOrgId, authnPolicy);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<AuthnPolicy> executeWithHttpInfo() throws ApiException {
            AuthnPolicy authnPolicy = buildBodyParams();
            return postWithHttpInfo(xOrgId, authnPolicy);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<AuthnPolicy> _callback) throws ApiException {
            AuthnPolicy authnPolicy = buildBodyParams();
            return postAsync(xOrgId, authnPolicy, _callback);
        }
    }
