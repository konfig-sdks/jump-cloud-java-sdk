...
public class Provider {
  public static final String SERIALIZED_NAME_DISALLOW_ORG_CREATION = "disallowOrgCreation";
  @SerializedName(SERIALIZED_NAME_DISALLOW_ORG_CREATION)
  private Boolean disallowOrgCreation;
  ...
  **/
  ...
  public Boolean getDisallowOrgCreation() {
    return disallowOrgCreation;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(disallowOrgCreation, id, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("disallowOrgCreation");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Provider.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
