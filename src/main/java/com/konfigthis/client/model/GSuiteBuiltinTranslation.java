 ...
 */
@JsonAdapter(GSuiteBuiltinTranslation.Adapter.class)public enum GSuiteBuiltinTranslation {
  ...
  public static GSuiteBuiltinTranslation fromValue(String value) {
  ...
  public static class Adapter extends TypeAdapter<GSuiteBuiltinTranslation> {
    ...
    public GSuiteBuiltinTranslation read(final JsonReader jsonReader) throws IOException {
      ...
      return GSuiteBuiltinTranslation.fromValue(value);
    }
  }
}
