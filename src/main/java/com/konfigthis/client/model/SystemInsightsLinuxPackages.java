...
public class SystemInsightsLinuxPackages {
  ...
  public static final String SERIALIZED_NAME_MAINTAINER_OR_VENDOR = "maintainer_or_vendor";
  @SerializedName(SERIALIZED_NAME_MAINTAINER_OR_VENDOR)
  private String maintainerOrVendor;

  public static final String SERIALIZED_NAME_MOUNT_NAMESPACE_ID = "mount_namespace_id";
  @SerializedName(SERIALIZED_NAME_MOUNT_NAMESPACE_ID)
  private String mountNamespaceId;
  ...
  public static final String SERIALIZED_NAME_PACKAGE_GROUP_OR_SECTION = "package_group_or_section";
  @SerializedName(SERIALIZED_NAME_PACKAGE_GROUP_OR_SECTION)
  private String packageGroupOrSection;

  public static final String SERIALIZED_NAME_PID_WITH_NAMESPACE = "pid_with_namespace";
  @SerializedName(SERIALIZED_NAME_PID_WITH_NAMESPACE)
  private Integer pidWithNamespace;

  public static final String SERIALIZED_NAME_RELEASE_OR_REVISION = "release_or_revision";
  @SerializedName(SERIALIZED_NAME_RELEASE_OR_REVISION)
  private String releaseOrRevision;
  ...
  public SystemInsightsLinuxPackages() {
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "3.0-11build1", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Ubuntu Developers <ubuntu-devel-discuss@lists.ubuntu.com>", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "id123", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "zip", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "deb", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "utils", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "11build1", value = "")
  ...
  **/
   ...
   * @return the SystemInsightsLinuxPackages instance itself
   */
  public SystemInsightsLinuxPackages putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, systemInsightsLinuxPackages.version) &&
        Objects.equals(this.arch, systemInsightsLinuxPackages.arch) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsLinuxPackages.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, arch, installTime, maintainerOrVendor, mountNamespaceId, name, packageFormat, packageGroupOrSection, pidWithNamespace, releaseOrRevision, size, systemId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("maintainer_or_vendor");
    openapiFields.add("mount_namespace_id");
    openapiFields.add("name");
    openapiFields.add("package_format");
    openapiFields.add("package_group_or_section");
    openapiFields.add("pid_with_namespace");
    openapiFields.add("release_or_revision");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsLinuxPackages
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsLinuxPackages.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsLinuxPackages is not found in the empty JSON string", SystemInsightsLinuxPackages.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("maintainer_or_vendor") != null && !jsonObj.get("maintainer_or_vendor").isJsonNull()) && !jsonObj.get("maintainer_or_vendor").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `maintainer_or_vendor` to be a primitive type in the JSON string but got `%s`", jsonObj.get("maintainer_or_vendor").toString()));
      }
      if ((jsonObj.get("mount_namespace_id") != null && !jsonObj.get("mount_namespace_id").isJsonNull()) && !jsonObj.get("mount_namespace_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `mount_namespace_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mount_namespace_id").toString()));
      }
      ...
      if ((jsonObj.get("package_group_or_section") != null && !jsonObj.get("package_group_or_section").isJsonNull()) && !jsonObj.get("package_group_or_section").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `package_group_or_section` to be a primitive type in the JSON string but got `%s`", jsonObj.get("package_group_or_section").toString()));
      }
      if ((jsonObj.get("release_or_revision") != null && !jsonObj.get("release_or_revision").isJsonNull()) && !jsonObj.get("release_or_revision").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `release_or_revision` to be a primitive type in the JSON string but got `%s`", jsonObj.get("release_or_revision").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsLinuxPackages.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsLinuxPackages' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsLinuxPackages> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsLinuxPackages.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsLinuxPackages>() {
           @Override
           public void write(JsonWriter out, SystemInsightsLinuxPackages value) throws IOException {
           ...
           @Override
           public SystemInsightsLinuxPackages read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsLinuxPackages instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsLinuxPackages given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsLinuxPackages
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsLinuxPackages
  */
  public static SystemInsightsLinuxPackages fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsLinuxPackages.class);
  }

 /**
  * Convert an instance of SystemInsightsLinuxPackages to an JSON string
  *
  * @return JSON string
  */
