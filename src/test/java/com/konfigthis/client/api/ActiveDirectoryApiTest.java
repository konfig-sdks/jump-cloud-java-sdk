...
public class ActiveDirectoryApiTest {
    ...
    private static ActiveDirectoryApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ActiveDirectoryApi(apiClient);
    }
     ...
     */
    @Test
    public void agentsDeleteTest() throws ApiException {
        String activedirectoryId = null;
        String agentId = null;
        String xOrgId = null;
        api.agentsDelete(activedirectoryId, agentId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void agentsGetTest() throws ApiException {
        String activedirectoryId = null;
        String agentId = null;
        String xOrgId = null;
        ActiveDirectoryAgentList response = api.agentsGet(activedirectoryId, agentId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void agentsListTest() throws ApiException {
        String activedirectoryId = null;
        Integer limit = null;
        Integer skip = null;
        List<String> sort = null;
        String xOrgId = null;
        List<ActiveDirectoryAgentList> response = api.agentsList(activedirectoryId)
                .limit(limit)
                .skip(skip)
                .sort(sort)
                .xOrgId(xOrgId)
     ...
     */
    @Test
    public void agentsPostTest() throws ApiException {
        String activedirectoryId = null;
        String agentType = null;
        String xOrgId = null;
        ActiveDirectoryAgentGet response = api.agentsPost(activedirectoryId)
                .agentType(agentType)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    ...
    public void deleteTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        ActiveDirectory response = api.delete(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        ActiveDirectory response = api.get(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        List<String> sort = null;
        String xOrgId = null;
        List<ActiveDirectory> response = api.list()
                .fields(fields)
                .filter(filter)
                .limit(limit)
                .skip(skip)
    ...
    public void patchTest() throws ApiException {
        ...
        String useCase = null;
        String xOrgId = null;
        ActiveDirectory response = api.patch(id)
                .domain(domain)
                .id(id)
    ...
    public void postTest() throws ApiException {
        ...
        String useCase = null;
        String xOrgId = null;
        ActiveDirectory response = api.post()
                .domain(domain)
                .id(id)
                .primaryAgent(primaryAgent)
                .useCase(useCase)
