...
public class ErrorDetails {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "HTTP status description")
  ...
  public ErrorDetails details(List<Map<String, Object>> details) {
  ...
  public ErrorDetails addDetailsItem(Map<String, Object> detailsItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, message, status, details, additionalProperties);
  }
