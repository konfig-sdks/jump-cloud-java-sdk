...
public class SystemsApiTest {
    ...
    private static SystemsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new SystemsApi(apiClient);
    }
     ...
     */
    @Test
    public void getFDEKeyTest() throws ApiException {
        String systemId = null;
        String xOrgId = null;
        Systemfdekey response = api.getFDEKey(systemId)
                .xOrgId(xOrgId)
                .execute();
     ...
     */
    @Test
    public void listSoftwareAppsWithStatusesTest() throws ApiException {
        String systemId = null;
        String xOrgId = null;
        ...
        List<SoftwareAppWithStatus> response = api.listSoftwareAppsWithStatuses(systemId)
                .xOrgId(xOrgId)
                .filter(filter)
                .limit(limit)
                .skip(skip)
