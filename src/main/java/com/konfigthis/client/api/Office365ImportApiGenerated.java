...
public class Office365ImportApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Office365ImportApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public Office365ImportApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
