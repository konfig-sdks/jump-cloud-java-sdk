...
public class UsersApiTest {
    ...
    public void deleteTest() throws ApiException {
        ...
        String xOrgId = null;
        PushEndpointResponse response = api.delete(userId, pushEndpointId)
                .xOrgId(xOrgId)
                .execute();
    ...
    public void getTest() throws ApiException {
        ...
        String pushEndpointId = null;
        String xOrgId = null;
        PushEndpointResponse response = api.get(userId, pushEndpointId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        String userId = null;
        String xOrgId = null;
        List<PushEndpointResponse> response = api.list(userId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void patchTest() throws ApiException {
        ...
        String state = null;
        String xOrgId = null;
        PushEndpointResponse response = api.patch(userId, pushEndpointId)
                .name(name)
                .state(state)
                .xOrgId(xOrgId)
                .execute();
