...
public class SystemInsightsBrowserPlugins {
  ...
  **/
  ...
  @ApiModelProperty(example = "LastPass Plugin", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4.1.7", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2019-06-03T19:41:30.858Z", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "com.lastpass.nplastpass", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "LastPass", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "/Library/Internet Plug-Ins/nplastpass.plugin/", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "7D175", value = "")
  ...
  **/
   ...
   * @return the SystemInsightsBrowserPlugins instance itself
   */
  public SystemInsightsBrowserPlugins putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, systemInsightsBrowserPlugins.description) &&
        Objects.equals(this.version, systemInsightsBrowserPlugins.version) &&
        Objects.equals(this.collectionTime, systemInsightsBrowserPlugins.collectionTime) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsBrowserPlugins.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, version, collectionTime, developmentRegion, disabled, identifier, name, _native, path, sdk, systemId, uid, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsBrowserPlugins
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsBrowserPlugins.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsBrowserPlugins is not found in the empty JSON string", SystemInsightsBrowserPlugins.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsBrowserPlugins.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsBrowserPlugins' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsBrowserPlugins> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsBrowserPlugins.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsBrowserPlugins>() {
           @Override
           public void write(JsonWriter out, SystemInsightsBrowserPlugins value) throws IOException {
           ...
           @Override
           public SystemInsightsBrowserPlugins read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsBrowserPlugins instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsBrowserPlugins given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsBrowserPlugins
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsBrowserPlugins
  */
  public static SystemInsightsBrowserPlugins fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsBrowserPlugins.class);
  }

 /**
  * Convert an instance of SystemInsightsBrowserPlugins to an JSON string
  *
  * @return JSON string
  */
