...
public class IdentityProvidersApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public IdentityProvidersApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public IdentityProvidersApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
