...
public class PolicyGroupAssociationsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PolicyGroupAssociationsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public PolicyGroupAssociationsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
