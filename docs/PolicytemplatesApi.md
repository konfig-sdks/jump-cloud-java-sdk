...
|------------- | ------------- | -------------|
| [**get**](PolicytemplatesApi.md#get) | **GET** /policytemplates/{id} | Get a specific Policy Template |
| [**list**](PolicytemplatesApi.md#list) | **GET** /policytemplates | Lists all of the Policy Templates |


<a name="get"></a>
# **get**
> PolicyTemplateWithDetails get(id).xOrgId(xOrgId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling PolicytemplatesApi#get");
...
<a name="list"></a>
# **list**
> List&lt;PolicyTemplate&gt; list().fields(fields).filter(filter).limit(limit).skip(skip).sort(sort).xOrgId(xOrgId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling PolicytemplatesApi#list");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
