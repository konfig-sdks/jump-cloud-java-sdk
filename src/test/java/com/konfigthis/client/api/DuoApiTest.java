...
public class DuoApiTest {
    ...
    private static DuoApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new DuoApi(apiClient);
    }
    ...
    public void accountDeleteTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        DuoAccount response = api.accountDelete(id)
                .xOrgId(xOrgId)
                .execute();
    ...
    public void accountGetTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        DuoAccount response = api.accountGet(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void accountListTest() throws ApiException {
        String xOrgId = null;
        List<DuoAccount> response = api.accountList()
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void accountPostTest() throws ApiException {
        String xOrgId = null;
        DuoAccount response = api.accountPost()
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void applicationDeleteTest() throws ApiException {
        ...
        String xOrgId = null;
        DuoApplication response = api.applicationDelete(accountId, applicationId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void applicationGetTest() throws ApiException {
        ...
        String applicationId = null;
        String xOrgId = null;
        DuoApplication response = api.applicationGet(accountId, applicationId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void applicationListTest() throws ApiException {
        String accountId = null;
        String xOrgId = null;
        List<DuoApplication> response = api.applicationList(accountId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void applicationPostTest() throws ApiException {
        String apiHost = null;
        ...
        String accountId = null;
        String xOrgId = null;
        DuoApplication response = api.applicationPost(apiHost, integrationKey, name, secretKey, accountId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void applicationUpdateTest() throws ApiException {
        ...
        String secretKey = null;
        String xOrgId = null;
        DuoApplication response = api.applicationUpdate(apiHost, integrationKey, name, accountId, applicationId)
                .secretKey(secretKey)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
