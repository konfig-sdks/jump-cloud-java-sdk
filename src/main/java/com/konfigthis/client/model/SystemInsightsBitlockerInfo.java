...
public class SystemInsightsBitlockerInfo {
  ...
  public static final String SERIALIZED_NAME_ENCRYPTION_METHOD = "encryption_method";
  @SerializedName(SERIALIZED_NAME_ENCRYPTION_METHOD)
  private String encryptionMethod;

  public static final String SERIALIZED_NAME_PERSISTENT_VOLUME_ID = "persistent_volume_id";
  @SerializedName(SERIALIZED_NAME_PERSISTENT_VOLUME_ID)
  private String persistentVolumeId;

  public static final String SERIALIZED_NAME_PROTECTION_STATUS = "protection_status";
  ...
  **/
   ...
   * @return the SystemInsightsBitlockerInfo instance itself
   */
  public SystemInsightsBitlockerInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.collectionTime, systemInsightsBitlockerInfo.collectionTime) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsBitlockerInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionTime, conversionStatus, deviceId, driveLetter, encryptionMethod, persistentVolumeId, protectionStatus, systemId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("encryption_method");
    openapiFields.add("persistent_volume_id");
    openapiFields.add("protection_status");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsBitlockerInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsBitlockerInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsBitlockerInfo is not found in the empty JSON string", SystemInsightsBitlockerInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("drive_letter") != null && !jsonObj.get("drive_letter").isJsonNull()) && !jsonObj.get("drive_letter").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `drive_letter` to be a primitive type in the JSON string but got `%s`", jsonObj.get("drive_letter").toString()));
      }
      if ((jsonObj.get("encryption_method") != null && !jsonObj.get("encryption_method").isJsonNull()) && !jsonObj.get("encryption_method").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `encryption_method` to be a primitive type in the JSON string but got `%s`", jsonObj.get("encryption_method").toString()));
      }
      if ((jsonObj.get("persistent_volume_id") != null && !jsonObj.get("persistent_volume_id").isJsonNull()) && !jsonObj.get("persistent_volume_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `persistent_volume_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("persistent_volume_id").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsBitlockerInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsBitlockerInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsBitlockerInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsBitlockerInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsBitlockerInfo>() {
           @Override
           public void write(JsonWriter out, SystemInsightsBitlockerInfo value) throws IOException {
           ...
           @Override
           public SystemInsightsBitlockerInfo read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsBitlockerInfo instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsBitlockerInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsBitlockerInfo
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsBitlockerInfo
  */
  public static SystemInsightsBitlockerInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsBitlockerInfo.class);
  }

 /**
  * Convert an instance of SystemInsightsBitlockerInfo to an JSON string
  *
  * @return JSON string
  */
