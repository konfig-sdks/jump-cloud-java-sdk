...
public class ApplicationsApiTest {
    ...
    public void createTest() throws ApiException {
        String applicationId = null;
        Boolean allowUserReactivation = null;
        List<ImportOperation> operations = null;
        String queryString = null;
        String xOrgId = null;
        JobId response = api.create(applicationId)
     ...
     */
    @Test
    public void deleteLogoTest() throws ApiException {
        String applicationId = null;
        String xOrgId = null;
        api.deleteLogo(applicationId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getTest() throws ApiException {
        String applicationId = null;
        String xOrgId = null;
        Object response = api.get(applicationId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void postLogoTest() throws ApiException {
        String applicationId = null;
        String xOrgId = null;
        File image = null;
        api.postLogo(applicationId)
                .xOrgId(xOrgId)
                .image(image)
                .execute();
        // TODO: test validations
    ...
    public void usersTest() throws ApiException {
        ...
        Integer limit = null;
        Integer skip = null;
        ImportUsersResponse response = api.users(applicationId)
                .filter(filter)
                .query(query)
                .sort(sort)
                .sortOrder(sortOrder)
