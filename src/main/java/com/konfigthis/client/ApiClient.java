...
public class ApiClient extends ApiClientCustom {
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        if (configuration != null) {
            if (configuration.xApiKey != null) {
                this.setXApiKey(configuration.xApiKey);
            }
    ...
    public String getXApiKey() {
        return ((ApiKeyAuth) this.getAuthentication("x-api-key")).getApiKey();
    }

    public void setXApiKey(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("x-api-key")).setApiKey(apiKey);
    }

    public void setXApiKeyPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("x-api-key")).setApiKeyPrefix(prefix);
    }
