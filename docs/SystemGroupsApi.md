...
|------------- | ------------- | -------------|
| [**applySuggestions**](SystemGroupsApi.md#applySuggestions) | **POST** /systemgroups/{group_id}/suggestions | Apply Suggestions for a System Group |
| [**createNewGroup**](SystemGroupsApi.md#createNewGroup) | **POST** /systemgroups | Create a new System Group |
| [**deleteGroup**](SystemGroupsApi.md#deleteGroup) | **DELETE** /systemgroups/{id} | Delete a System Group |
| [**listAll**](SystemGroupsApi.md#listAll) | **GET** /systemgroups | List all System Groups |
| [**listSuggestions**](SystemGroupsApi.md#listSuggestions) | **GET** /systemgroups/{group_id}/suggestions | List Suggestions for a System Group |
| [**systemGroupAssociationsList**](SystemGroupsApi.md#systemGroupAssociationsList) | **GET** /systemgroups/{group_id}/associations | List the associations of a System Group |
| [**systemGroupAssociationsPost**](SystemGroupsApi.md#systemGroupAssociationsPost) | **POST** /systemgroups/{group_id}/associations | Manage the associations of a System Group |
| [**systemGroupMembersList**](SystemGroupsApi.md#systemGroupMembersList) | **GET** /systemgroups/{group_id}/members | List the members of a System Group |
| [**systemGroupMembersPost**](SystemGroupsApi.md#systemGroupMembersPost) | **POST** /systemgroups/{group_id}/members | Manage the members of a System Group |
| [**systemGroupMembership**](SystemGroupsApi.md#systemGroupMembership) | **GET** /systemgroups/{group_id}/membership | List the System Group&#39;s membership |
| [**systemGroupTraversePolicy**](SystemGroupsApi.md#systemGroupTraversePolicy) | **GET** /systemgroups/{group_id}/policies | List the Policies bound to a System Group |
| [**systemGroupTraversePolicyGroup**](SystemGroupsApi.md#systemGroupTraversePolicyGroup) | **GET** /systemgroups/{group_id}/policygroups | List the Policy Groups bound to a System Group |
| [**systemGroupTraverseUser**](SystemGroupsApi.md#systemGroupTraverseUser) | **GET** /systemgroups/{group_id}/users | List the Users bound to a System Group |
| [**systemGroupTraverseUserGroup**](SystemGroupsApi.md#systemGroupTraverseUserGroup) | **GET** /systemgroups/{group_id}/usergroups | List the User Groups bound to a System Group |
| [**updateGroup**](SystemGroupsApi.md#updateGroup) | **PUT** /systemgroups/{id} | Update a System Group |
| [**viewDetails**](SystemGroupsApi.md#viewDetails) | **GET** /systemgroups/{id} | View an individual System Group details |


<a name="applySuggestions"></a>
# **applySuggestions**
> Object applySuggestions(groupId, systemGroupsApplySuggestionsRequest).xOrgId(xOrgId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#applySuggestions");
...
| **systemGroupsApplySuggestionsRequest** | [**SystemGroupsApplySuggestionsRequest**](SystemGroupsApplySuggestionsRequest.md)|  | |
...
# **createNewGroup**
> SystemGroup createNewGroup().xOrgId(xOrgId).systemGroupPost(systemGroupPost).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    configuration.xApiKey  = "YOUR API KEY";
    JumpCloud client = new JumpCloud(configuration);
    String name = "name_example"; // Display name of a System Group.
    String description = "description_example"; // Description of a System Group
    Map<String, Object> attributes = new HashMap(); // The graph attributes.
    String email = "email_example"; // Email address of a System Group
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#createNewGroup");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<SystemGroup> response = client
              .systemGroups
              .createNewGroup(name)
              .description(description)
              .attributes(attributes)
...
|------------- | ------------- | ------------- | -------------|
| **xOrgId** | **String**| Organization identifier that can be obtained from console settings. | [optional] |
| **systemGroupPost** | [**SystemGroupPost**](SystemGroupPost.md)|  | [optional] |
...
# **deleteGroup**
> SystemGroup deleteGroup(id).xOrgId(xOrgId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    configuration.xApiKey  = "YOUR API KEY";
    JumpCloud client = new JumpCloud(configuration);
    String id = "id_example"; // ObjectID of the System Group.
    String xOrgId = "xOrgId_example"; // Organization identifier that can be obtained from console settings.
    try {
      SystemGroup result = client
              .systemGroups
      ...
      System.err.println("Exception when calling SystemGroupsApi#deleteGroup");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="listAll"></a>
# **listAll**
> List&lt;SystemGroup&gt; listAll().fields(fields).filter(filter).limit(limit).skip(skip).sort(sort).xOrgId(xOrgId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String xOrgId = "xOrgId_example"; // Organization identifier that can be obtained from console settings.
    try {
      List<SystemGroup> result = client
              .systemGroups
              .listAll()
              .fields(fields)
              .filter(filter)
      ...
      System.err.println("Exception when calling SystemGroupsApi#listAll");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<List<SystemGroup>> response = client
              .systemGroups
              .listAll()
              .fields(fields)
              .filter(filter)
...
<a name="listSuggestions"></a>
# **listSuggestions**
> List&lt;MemberSuggestion&gt; listSuggestions(groupId).xOrgId(xOrgId).limit(limit).skip(skip).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#listSuggestions");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#systemGroupAssociationsList");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#systemGroupAssociationsPost");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#systemGroupMembersList");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#systemGroupMembersPost");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#systemGroupMembership");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#systemGroupTraversePolicy");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#systemGroupTraversePolicyGroup");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#systemGroupTraverseUser");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#systemGroupTraverseUserGroup");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **updateGroup**
> SystemGroup updateGroup(id).xOrgId(xOrgId).systemGroupPut(systemGroupPut).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#updateGroup");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **id** | **String**| ObjectID of the System Group. | |
| **xOrgId** | **String**| Organization identifier that can be obtained from console settings. | [optional] |
| **systemGroupPut** | [**SystemGroupPut**](SystemGroupPut.md)|  | [optional] |
...
# **viewDetails**
> SystemGroup viewDetails(id).xOrgId(xOrgId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SystemGroupsApi#viewDetails");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
