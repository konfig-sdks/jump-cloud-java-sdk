...
public class AdministratorsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AdministratorsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public AdministratorsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
