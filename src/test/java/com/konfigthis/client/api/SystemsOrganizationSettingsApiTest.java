...
/**
 * API tests for SystemsOrganizationSettingsApi
 */
@Disabled
public class SystemsOrganizationSettingsApiTest {

    private static SystemsOrganizationSettingsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new SystemsOrganizationSettingsApi(apiClient);
    }
     ...
     */
    @Test
    public void getDefaultPasswordSyncSettingsTest() throws ApiException {
        byte[] organizationObjectId = null;
        DevicesGetDefaultPasswordSyncSettingsResponse response = api.getDefaultPasswordSyncSettings()
     ...
     */
    @Test
    public void getSignInWithJumpCloudSettingsTest() throws ApiException {
        byte[] organizationObjectId = null;
        DevicesGetSignInWithJumpCloudSettingsResponse response = api.getSignInWithJumpCloudSettings()
                .organizationObjectId(organizationObjectId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void setDefaultPasswordSyncSettingsTest() throws ApiException {
        Boolean enabled = null;
        byte[] organizationObjectId = null;
        Object response = api.setDefaultPasswordSyncSettings()
                .enabled(enabled)
                .organizationObjectId(organizationObjectId)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void setSignInWithJumpCloudSettingsTest() throws ApiException {
        byte[] organizationObjectId = null;
        List<DevicesSignInWithJumpCloudSetting> settings = null;
        Object response = api.setSignInWithJumpCloudSettings()
                .organizationObjectId(organizationObjectId)
                .settings(settings)
                .execute();
        // TODO: test validations
