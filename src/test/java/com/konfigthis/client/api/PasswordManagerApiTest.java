...
/**
 * API tests for PasswordManagerApi
 */
@Disabled
public class PasswordManagerApiTest {

    private static PasswordManagerApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PasswordManagerApi(apiClient);
    }
    ...
    public void getDeviceTest() throws ApiException {
        String UUID = null;
        DevicePackageV1Device response = api.getDevice(UUID)
                .execute();
    ...
    public void listDevicesTest() throws ApiException {
        ...
        DevicePackageV1ListDevicesResponse response = api.listDevices()
                .limit(limit)
                .skip(skip)
                .sort(sort)
                .fields(fields)
