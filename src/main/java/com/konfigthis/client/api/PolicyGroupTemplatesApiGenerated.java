...
public class PolicyGroupTemplatesApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PolicyGroupTemplatesApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public PolicyGroupTemplatesApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
