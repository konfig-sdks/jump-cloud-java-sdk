...
public class PwmUserItem {
  ...
  public PwmUserItem field1(String field1) {
  ...
  **/
  ...
  public PwmUserItem field2(String field2) {
  ...
  **/
  ...
  public PwmUserItem folderName(String folderName) {
  ...
  **/
  ...
  public PwmUserItem folderUuid(UUID folderUuid) {
  ...
  **/
  ...
  public PwmUserItem id(String id) {
  ...
  **/
  ...
  public PwmUserItem itemUuid(UUID itemUuid) {
  ...
  **/
  ...
  public PwmUserItem nickname(String nickname) {
  ...
  **/
  ...
  public PwmUserItem type(Integer type) {
  ...
  **/
   ...
   * @return the PwmUserItem instance itself
   */
  public PwmUserItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PwmUserItem pwmUserItem = (PwmUserItem) o;
    return Objects.equals(this.field1, pwmUserItem.field1) &&
        Objects.equals(this.field2, pwmUserItem.field2) &&
        Objects.equals(this.folderName, pwmUserItem.folderName) &&
        Objects.equals(this.folderUuid, pwmUserItem.folderUuid) &&
        Objects.equals(this.id, pwmUserItem.id) &&
        Objects.equals(this.itemUuid, pwmUserItem.itemUuid) &&
        Objects.equals(this.nickname, pwmUserItem.nickname) &&
        Objects.equals(this.type, pwmUserItem.type)&&
        Objects.equals(this.additionalProperties, pwmUserItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(field1, field2, folderName, folderUuid, id, itemUuid, nickname, type, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PwmUserItem {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PwmUserItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PwmUserItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PwmUserItem is not found in the empty JSON string", PwmUserItem.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PwmUserItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PwmUserItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PwmUserItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PwmUserItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PwmUserItem.class));

       return (TypeAdapter<T>) new TypeAdapter<PwmUserItem>() {
           @Override
           public void write(JsonWriter out, PwmUserItem value) throws IOException {
           ...
           @Override
           public PwmUserItem read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PwmUserItem instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PwmUserItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PwmUserItem
  * @throws IOException if the JSON string is invalid with respect to PwmUserItem
  */
  public static PwmUserItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PwmUserItem.class);
  }

 /**
  * Convert an instance of PwmUserItem to an JSON string
  *
  * @return JSON string
  */
