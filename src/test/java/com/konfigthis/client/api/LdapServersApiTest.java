...
public class LdapServersApiTest {
    ...
    private static LdapServersApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new LdapServersApi(apiClient);
    }
    ...
    public void getTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        LdapServer response = api.get(id)
                .xOrgId(xOrgId)
                .execute();
    ...
    public void listTest() throws ApiException {
        ...
        String xOrgId = null;
        List<LdapServer> response = api.list()
                .fields(fields)
                .filter(filter)
                .limit(limit)
                .skip(skip)
    ...
    public void patchTest() throws ApiException {
        String id = null;
        String id = null;
        LdapServerAction userLockoutAction = null;
        LdapServerAction userPasswordExpirationAction = null;
        String xOrgId = null;
        LdapserversPatchResponse response = api.patch(id)
                .id(id)
