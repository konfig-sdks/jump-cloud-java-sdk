...
public class SystemInsightsGroups {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "701", value = "")
  ...
  **/
   ...
   * @return the SystemInsightsGroups instance itself
   */
  public SystemInsightsGroups putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.collectionTime, systemInsightsGroups.collectionTime) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsGroups.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionTime, comment, gid, gidSigned, groupSid, groupname, systemId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsGroups
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsGroups.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsGroups is not found in the empty JSON string", SystemInsightsGroups.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsGroups.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsGroups' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsGroups> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsGroups.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsGroups>() {
           @Override
           public void write(JsonWriter out, SystemInsightsGroups value) throws IOException {
           ...
           @Override
           public SystemInsightsGroups read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsGroups instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsGroups given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsGroups
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsGroups
  */
  public static SystemInsightsGroups fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsGroups.class);
  }

 /**
  * Convert an instance of SystemInsightsGroups to an JSON string
  *
  * @return JSON string
  */
