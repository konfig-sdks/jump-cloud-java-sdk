...
public class Subscription {
  public static final String SERIALIZED_NAME_ANNUAL_PRICE = "annualPrice";
  @SerializedName(SERIALIZED_NAME_ANNUAL_PRICE)
  ...
  public Subscription annualPrice(Double annualPrice) {
  ...
  public Subscription annualPrice(Integer annualPrice) {
    
    
    
    
    this.annualPrice = annualPrice.doubleValue();
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The annual (discounted) price of this subscription.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The display name of this subscription.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Array of the features included in the subscription.")
  ...
  public Subscription listPrice(Double listPrice) {
  ...
  public Subscription listPrice(Integer listPrice) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The list price of this subscription.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Unique identifier corresponding to this subscription.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(annualPrice, displayName, features, listPrice, productCode, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("annualPrice");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (int i = 0; i < jsonArrayfeatures.size(); i++) {
        Feature.validateJsonObject(jsonArrayfeatures.get(i).getAsJsonObject());
      };
