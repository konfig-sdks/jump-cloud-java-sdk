...
public class SystemInsightsDiskInfo {
  ...
  public static final String SERIALIZED_NAME_PNP_DEVICE_ID = "pnp_device_id";
  @SerializedName(SERIALIZED_NAME_PNP_DEVICE_ID)
  ...
  **/
  ...
  @ApiModelProperty(example = "Disk drive", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "64420392960", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "VMware, VMware Virtual S SCSI Disk Device", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "\\\\.\\PHYSICALDRIVE0", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "(Standard disk drives)", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SCSI\\DISK&VEN_VMWARE_&PROD_VMWARE_VIRTUAL_S\\5&1EC51BF7&0&000000", value = "")
  ...
  **/
   ...
   * @return the SystemInsightsDiskInfo instance itself
   */
  public SystemInsightsDiskInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, systemInsightsDiskInfo.description) &&
        Objects.equals(this.collectionTime, systemInsightsDiskInfo.collectionTime) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsDiskInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, collectionTime, diskIndex, diskSize, hardwareModel, id, manufacturer, name, partitions, pnpDeviceId, serial, systemId, type, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("pnp_device_id");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsDiskInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsDiskInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsDiskInfo is not found in the empty JSON string", SystemInsightsDiskInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("disk_size") != null && !jsonObj.get("disk_size").isJsonNull()) && !jsonObj.get("disk_size").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `disk_size` to be a primitive type in the JSON string but got `%s`", jsonObj.get("disk_size").toString()));
      }
      ...
      if ((jsonObj.get("pnp_device_id") != null && !jsonObj.get("pnp_device_id").isJsonNull()) && !jsonObj.get("pnp_device_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `pnp_device_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("pnp_device_id").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsDiskInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsDiskInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsDiskInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsDiskInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsDiskInfo>() {
           @Override
           public void write(JsonWriter out, SystemInsightsDiskInfo value) throws IOException {
           ...
           @Override
           public SystemInsightsDiskInfo read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsDiskInfo instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsDiskInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsDiskInfo
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsDiskInfo
  */
  public static SystemInsightsDiskInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsDiskInfo.class);
  }

 /**
  * Convert an instance of SystemInsightsDiskInfo to an JSON string
  *
  * @return JSON string
  */
