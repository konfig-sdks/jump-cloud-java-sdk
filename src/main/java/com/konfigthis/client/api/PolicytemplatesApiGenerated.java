...
public class PolicytemplatesApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PolicytemplatesApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public PolicytemplatesApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private ApiResponse<PolicyTemplateWithDetails> getWithHttpInfo(String id, String xOrgId) throws ApiException {
    ...
    private okhttp3.Call getAsync(String id, String xOrgId, final ApiCallback<PolicyTemplateWithDetails> _callback) throws ApiException {
    ...
    public class GetRequestBuilder {
        ...
        public PolicyTemplateWithDetails execute() throws ApiException {
            ApiResponse<PolicyTemplateWithDetails> localVarResp = getWithHttpInfo(id, xOrgId);
    ...
    private ApiResponse<List<PolicyTemplate>> listWithHttpInfo(List<String> fields, List<String> filter, Integer limit, Integer skip, List<String> sort, String xOrgId) throws ApiException {
    ...
    private okhttp3.Call listAsync(List<String> fields, List<String> filter, Integer limit, Integer skip, List<String> sort, String xOrgId, final ApiCallback<List<PolicyTemplate>> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
        ...
        public List<PolicyTemplate> execute() throws ApiException {
            ApiResponse<List<PolicyTemplate>> localVarResp = listWithHttpInfo(fields, filter, limit, skip, sort, xOrgId);
            return localVarResp.getResponseBody();
        }
