...
public class SambaDomainsApiTest {
    ...
    private static SambaDomainsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new SambaDomainsApi(apiClient);
    }
     ...
     */
    @Test
    public void sambaDomainsDeleteTest() throws ApiException {
        String ldapserverId = null;
        String id = null;
        String xOrgId = null;
        String response = api.sambaDomainsDelete(ldapserverId, id)
                .xOrgId(xOrgId)
                .execute();
     ...
     */
    @Test
    public void sambaDomainsGetTest() throws ApiException {
        String ldapserverId = null;
        String id = null;
        String xOrgId = null;
        SambaDomain response = api.sambaDomainsGet(ldapserverId, id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void sambaDomainsListTest() throws ApiException {
        String ldapserverId = null;
        ...
        String xOrgId = null;
        List<SambaDomain> response = api.sambaDomainsList(ldapserverId)
                .fields(fields)
                .filter(filter)
                .limit(limit)
                .skip(skip)
     ...
     */
    @Test
    public void sambaDomainsPostTest() throws ApiException {
        String name = null;
        String sid = null;
        String ldapserverId = null;
        String id = null;
        String xOrgId = null;
        SambaDomain response = api.sambaDomainsPost(name, sid, ldapserverId)
                .id(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void sambaDomainsPutTest() throws ApiException {
        String name = null;
        String sid = null;
        String ldapserverId = null;
        String id = null;
        String id = null;
        SambaDomain response = api.sambaDomainsPut(name, sid, ldapserverId, id)
                .id(id)
                .execute();
        // TODO: test validations
    }
