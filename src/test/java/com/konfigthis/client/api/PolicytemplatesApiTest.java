...
public class PolicytemplatesApiTest {
    ...
    private static PolicytemplatesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PolicytemplatesApi(apiClient);
    }
    ...
    public void getTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        PolicyTemplateWithDetails response = api.get(id)
                .xOrgId(xOrgId)
                .execute();
    ...
    public void listTest() throws ApiException {
        ...
        String xOrgId = null;
        List<PolicyTemplate> response = api.list()
                .fields(fields)
                .filter(filter)
                .limit(limit)
                .skip(skip)
