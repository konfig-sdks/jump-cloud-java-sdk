...
public class GoogleRpcStatus {
  ...
  **/
  ...
  public GoogleRpcStatus details(List<GoogleProtobufAny> details) {
  ...
  public GoogleRpcStatus addDetailsItem(GoogleProtobufAny detailsItem) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GoogleRpcStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GoogleRpcStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
