...
public class Office365ApiTest {
    ...
    private static Office365Api api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new Office365Api(apiClient);
    }
    ...
    public void deleteTest() throws ApiException {
        byte[] office365Id = null;
        byte[] domainId = null;
        O365DomainResponse response = api.delete(office365Id, domainId)
                .execute();
    ...
    public void getTest() throws ApiException {
        ...
        String xOrgId = null;
        Office365 response = api.get(office365Id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void insertTest() throws ApiException {
        byte[] office365Id = null;
        String domain = null;
        O365DomainResponse response = api.insert(office365Id)
                .domain(domain)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        String limit = null;
        String skip = null;
        O365DomainsListResponse response = api.list(office365Id)
                .limit(limit)
                .skip(skip)
                .execute();
        // TODO: test validations
    ...
    public void listImportUsersTest() throws ApiException {
        ...
        String orderby = null;
        Boolean count = null;
        Office365SListImportUsersResponse response = api.listImportUsers(office365Id)
     ...
     */
    @Test
    public void office365DeleteTest() throws ApiException {
        String office365Id = null;
        String id = null;
        api.office365Delete(office365Id, id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void office365GetTest() throws ApiException {
        String office365Id = null;
        String id = null;
        Office365TranslationRule response = api.office365Get(office365Id, id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void office365ListTest() throws ApiException {
        String office365Id = null;
        ...
        List<Office365TranslationRule> response = api.office365List(office365Id)
                .fields(fields)
                .filter(filter)
                .limit(limit)
                .skip(skip)
     ...
     */
    @Test
    public void office365PostTest() throws ApiException {
        String office365Id = null;
        Office365BuiltinTranslation builtIn = null;
        Office365DirectionTranslation direction = null;
        Office365TranslationRule response = api.office365Post(office365Id)
                .builtIn(builtIn)
                .direction(direction)
                .execute();
        // TODO: test validations
    ...
    public void patchTest() throws ApiException {
        ...
        String xOrgId = null;
        Office365 response = api.patch(office365Id)
