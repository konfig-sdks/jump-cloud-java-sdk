...
/**
 * API tests for PolicyGroupTemplatesApi
 */
@Disabled
public class PolicyGroupTemplatesApiTest {

    private static PolicyGroupTemplatesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PolicyGroupTemplatesApi(apiClient);
    }
