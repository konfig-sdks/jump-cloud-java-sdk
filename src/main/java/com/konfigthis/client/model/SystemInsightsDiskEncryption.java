...
public class SystemInsightsDiskEncryption {
  ...
  public static final String SERIALIZED_NAME_ENCRYPTION_STATUS = "encryption_status";
  ...
  **/
  ...
  @ApiModelProperty(example = "2019-06-03T19:41:31.557Z", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "/dev/disk8", value = "")
  ...
  **/
   ...
   * @return the SystemInsightsDiskEncryption instance itself
   */
  public SystemInsightsDiskEncryption putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.collectionTime, systemInsightsDiskEncryption.collectionTime) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsDiskEncryption.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionTime, encrypted, encryptionStatus, name, systemId, type, uid, userUuid, uuid, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("encryption_status");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsDiskEncryption
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsDiskEncryption.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsDiskEncryption is not found in the empty JSON string", SystemInsightsDiskEncryption.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("encryption_status") != null && !jsonObj.get("encryption_status").isJsonNull()) && !jsonObj.get("encryption_status").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `encryption_status` to be a primitive type in the JSON string but got `%s`", jsonObj.get("encryption_status").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsDiskEncryption.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsDiskEncryption' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsDiskEncryption> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsDiskEncryption.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsDiskEncryption>() {
           @Override
           public void write(JsonWriter out, SystemInsightsDiskEncryption value) throws IOException {
           ...
           @Override
           public SystemInsightsDiskEncryption read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsDiskEncryption instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsDiskEncryption given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsDiskEncryption
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsDiskEncryption
  */
  public static SystemInsightsDiskEncryption fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsDiskEncryption.class);
  }

 /**
  * Convert an instance of SystemInsightsDiskEncryption to an JSON string
  *
  * @return JSON string
  */
