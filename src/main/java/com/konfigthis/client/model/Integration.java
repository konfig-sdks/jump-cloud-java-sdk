 ...
 * An integration.
 */
@ApiModel(description = "An integration.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Integration {
  ...
  **/
  ...
  @ApiModelProperty(value = "Unique identifier for this integration")
  ...
  **/
   ...
   * @return the Integration instance itself
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(integrationId, type, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Integration>() {
           ...
           public Integration read(JsonReader in) throws IOException {
             ...
             Integration instance = thisAdapter.fromJsonTree(jsonObj);
