...
import com.konfigthis.client.model.PolicyTemplateConfigFieldTooltip;
...
public class PolicyTemplateConfigField {
 ...
 public enum DisplayTypeEnum {
  ...
  private PolicyTemplateConfigFieldTooltip tooltip;
  ...
  **/
  ...
  @ApiModelProperty(value = "The default value for this field.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The options that correspond to the display_type.")
  ...
  **/
  ...
  public PolicyTemplateConfigField position(Double position) {
  ...
  public PolicyTemplateConfigField position(Integer position) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Defines if the policy template config field is sensitive or not.")
  ...
  **/
  ...
  public PolicyTemplateConfigField validators(Object validators) {
   ...
   /**
   * Descriptors to perform extended assertions on the supplied config field value.
   * @return validators
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Descriptors to perform extended assertions on the supplied config field value.")
   ...
   * @return the PolicyTemplateConfigField instance itself
   */
  public PolicyTemplateConfigField putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultValue, policyTemplateConfigField.defaultValue) &&
        ...
        Objects.equals(this.validators, policyTemplateConfigField.validators)&&
        Objects.equals(this.additionalProperties, policyTemplateConfigField.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(defaultValue, displayOptions, displayType, id, label, name, position, readOnly, required, sensitive, tooltip, validators, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PolicyTemplateConfigField
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PolicyTemplateConfigField.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyTemplateConfigField is not found in the empty JSON string", PolicyTemplateConfigField.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PolicyTemplateConfigField.openapiRequiredFields) {
      ...
      if (jsonObj.get("tooltip") != null && !jsonObj.get("tooltip").isJsonNull()) {
        PolicyTemplateConfigFieldTooltip.validateJsonObject(jsonObj.getAsJsonObject("tooltip"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyTemplateConfigField.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyTemplateConfigField' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyTemplateConfigField> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyTemplateConfigField.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyTemplateConfigField>() {
           @Override
           public void write(JsonWriter out, PolicyTemplateConfigField value) throws IOException {
           ...
           @Override
           public PolicyTemplateConfigField read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PolicyTemplateConfigField instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PolicyTemplateConfigField given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PolicyTemplateConfigField
  * @throws IOException if the JSON string is invalid with respect to PolicyTemplateConfigField
  */
  public static PolicyTemplateConfigField fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyTemplateConfigField.class);
  }

 /**
  * Convert an instance of PolicyTemplateConfigField to an JSON string
  *
  * @return JSON string
  */
