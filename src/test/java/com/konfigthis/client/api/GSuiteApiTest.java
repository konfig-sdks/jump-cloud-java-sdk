...
public class GSuiteApiTest {
    ...
    private static GSuiteApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new GSuiteApi(apiClient);
    }
    ...
    public void addDomainTest() throws ApiException {
        byte[] gsuiteId = null;
        String domain = null;
        JumpcloudGappsDomainResponse response = api.addDomain(gsuiteId)
                .domain(domain)
                .execute();
     ...
     */
    @Test
    public void configuredDomainsListTest() throws ApiException {
        byte[] gsuiteId = null;
        String limit = null;
        String skip = null;
        JumpcloudGappsDomainListResponse response = api.configuredDomainsList(gsuiteId)
                .limit(limit)
                .skip(skip)
                .execute();
        // TODO: test validations
    ...
    public void deleteDomainTest() throws ApiException {
        byte[] gsuiteId = null;
        byte[] domainId = null;
        JumpcloudGappsDomainResponse response = api.deleteDomain(gsuiteId, domainId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void gSuiteDeleteTest() throws ApiException {
        String gsuiteId = null;
        String id = null;
        api.gSuiteDelete(gsuiteId, id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void gSuiteGetTest() throws ApiException {
        String gsuiteId = null;
        String id = null;
        GSuiteTranslationRule response = api.gSuiteGet(gsuiteId, id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void gSuiteListTest() throws ApiException {
        String gsuiteId = null;
        ...
        List<GSuiteTranslationRule> response = api.gSuiteList(gsuiteId)
                .fields(fields)
                .filter(filter)
                .limit(limit)
                .skip(skip)
     ...
     */
    @Test
    public void gSuitePostTest() throws ApiException {
        String gsuiteId = null;
        GSuiteBuiltinTranslation builtIn = null;
        GSuiteDirectionTranslation direction = null;
        GSuiteTranslationRule response = api.gSuitePost(gsuiteId)
                .builtIn(builtIn)
                .direction(direction)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void listImportJumpcloudUsersTest() throws ApiException {
        String gsuiteId = null;
        ...
        GsuitesListImportJumpcloudUsersResponse response = api.listImportJumpcloudUsers(gsuiteId)
     ...
     */
    @Test
    public void listImportUsersTest() throws ApiException {
        String gsuiteId = null;
        Integer limit = null;
        Integer maxResults = null;
        String orderBy = null;
        ...
        String query = null;
        String sortOrder = null;
        GsuitesListImportUsersResponse response = api.listImportUsers(gsuiteId)
                .limit(limit)
                .maxResults(maxResults)
                .orderBy(orderBy)
                .pageToken(pageToken)
    ...
    public void patchTest() throws ApiException {
        ...
        Boolean groupsEnabled = null;
        String id = null;
        String name = null;
        String userLockoutAction = null;
        String userPasswordExpirationAction = null;
        String xOrgId = null;
        Gsuite response = api.patch(id)
