...
public class SystemInsightsChromeExtensions {
  ...
  **/
  ...
  @ApiModelProperty(example = "provider for discovery and services for mirroring of chrome media router", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "7419.311.0.1", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2019-06-03t19:41:31.125z", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "pkedcjkdefgpdelpbcmbmeomcjbeemfm", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "chrome media router", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "/users/thomas/library/application support/google/chrome/default/extensions/pkedcjkdefgpdelpbcmbmeomcjbeemfm/7419.311.0.1_0/", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "alarms, cast, cast.streaming, declarativewebrequest, desktopcapture, gcm, http://_*_/_*, identity, identity.email, management, mdns, mediarouterprivate, metricsprivate, networkingprivate, processes, storage, system.cpu, settingsprivate, tabcapture, tabs, webview, https://hangouts.google.com/_*, https://_*.google.com/cast/chromecast/home/gsse", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://clients2.google.com/service/update2/crx", value = "")
   ...
   * @return the SystemInsightsChromeExtensions instance itself
   */
  public SystemInsightsChromeExtensions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, systemInsightsChromeExtensions.description) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsChromeExtensions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, version, author, collectionTime, identifier, locale, name, path, permissions, persistent, systemId, uid, updateUrl, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsChromeExtensions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsChromeExtensions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsChromeExtensions is not found in the empty JSON string", SystemInsightsChromeExtensions.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsChromeExtensions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsChromeExtensions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsChromeExtensions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsChromeExtensions.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsChromeExtensions>() {
           @Override
           public void write(JsonWriter out, SystemInsightsChromeExtensions value) throws IOException {
           ...
           @Override
           public SystemInsightsChromeExtensions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsChromeExtensions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsChromeExtensions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsChromeExtensions
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsChromeExtensions
  */
  public static SystemInsightsChromeExtensions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsChromeExtensions.class);
  }

 /**
  * Convert an instance of SystemInsightsChromeExtensions to an JSON string
  *
  * @return JSON string
  */
