...
public class SystemGroupMembersMembershipApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public SystemGroupMembersMembershipApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public SystemGroupMembersMembershipApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
