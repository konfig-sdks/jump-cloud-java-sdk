 ...
 */
@JsonAdapter(Office365BuiltinTranslation.Adapter.class)public enum Office365BuiltinTranslation {
  ...
  PRINCIPAL_NAME_FROM_ALTERNATE_EMAIL("user_principal_name_from_alternate_email"),
  ...
  public static Office365BuiltinTranslation fromValue(String value) {
  ...
  public static class Adapter extends TypeAdapter<Office365BuiltinTranslation> {
    ...
    public Office365BuiltinTranslation read(final JsonReader jsonReader) throws IOException {
      ...
      return Office365BuiltinTranslation.fromValue(value);
    }
  }
}
