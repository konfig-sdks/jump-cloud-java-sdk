...
public class UserGroupsApiTest {
    ...
    public void createNewGroupTest() throws ApiException {
        ...
        GroupAttributesUserGroup attributes = null;
        String email = null;
        ...
        String xOrgId = null;
        UserGroup response = api.createNewGroup(name)
    ...
    public void deleteGroupTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        UserGroup response = api.deleteGroup(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getDetailsTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        UserGroup response = api.getDetails(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getSuggestionsTest() throws ApiException {
        ...
        Integer limit = null;
        Integer skip = null;
        List<MemberSuggestion> response = api.getSuggestions(groupId)
                .xOrgId(xOrgId)
                .limit(limit)
                .skip(skip)
                .execute();
    ...
    public void listAllTest() throws ApiException {
        ...
        String xOrgId = null;
        List<UserGroup> response = api.listAll()
                .fields(fields)
                .filter(filter)
                .limit(limit)
                .skip(skip)
    ...
    public void updateGroupTest() throws ApiException {
        ...
        GroupMembershipMethodType membershipMethod = null;
        String xOrgId = null;
        UserGroup response = api.updateGroup(name, id)
                .description(description)
                .attributes(attributes)
                .email(email)
                .memberQuery(memberQuery)
