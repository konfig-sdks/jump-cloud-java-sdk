...
public class PolicyGroupMembersMembershipApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PolicyGroupMembersMembershipApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public PolicyGroupMembersMembershipApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
