...
import com.konfigthis.client.model.DirectoryDefaultDomain;
...
public class Directory {
  ...
  private DirectoryDefaultDomain defaultDomain;
  ...
  public static final String SERIALIZED_NAME_O_AUTH_STATUS = "oAuthStatus";
  @SerializedName(SERIALIZED_NAME_O_AUTH_STATUS)
  private Object oAuthStatus;
 ...
 public enum TypeEnum {
  ...
  public Directory defaultDomain(DirectoryDefaultDomain defaultDomain) {
  ...
  **/
  ...
  public DirectoryDefaultDomain getDefaultDomain() {
    return defaultDomain;
  }


  public void setDefaultDomain(DirectoryDefaultDomain defaultDomain) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "the expiry and error status of the bearer token")
  ...
  **/
   ...
   * @return the Directory instance itself
   */
  public Directory putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultDomain, directory.defaultDomain) &&
        ...
        Objects.equals(this.additionalProperties, directory.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(defaultDomain, id, name, oAuthStatus, type, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Directory
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Directory.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Directory.openapiRequiredFields) {
      ...
      if (jsonObj.get("defaultDomain") != null && !jsonObj.get("defaultDomain").isJsonNull()) {
        DirectoryDefaultDomain.validateJsonObject(jsonObj.getAsJsonObject("defaultDomain"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Directory>() {
           ...
           public Directory read(JsonReader in) throws IOException {
             ...
             Directory instance = thisAdapter.fromJsonTree(jsonObj);
