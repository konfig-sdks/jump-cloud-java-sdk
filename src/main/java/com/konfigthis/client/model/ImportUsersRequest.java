...
public class ImportUsersRequest {
  public static final String SERIALIZED_NAME_ALLOW_USER_REACTIVATION = "allowUserReactivation";
  @SerializedName(SERIALIZED_NAME_ALLOW_USER_REACTIVATION)
  private Boolean allowUserReactivation = true;

  public static final String SERIALIZED_NAME_OPERATIONS = "operations";
  @SerializedName(SERIALIZED_NAME_OPERATIONS)
  private List<ImportOperation> operations = null;
  ...
  public ImportUsersRequest allowUserReactivation(Boolean allowUserReactivation) {
   ...
   * @return allowUserReactivation
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "A boolean value to allow the reactivation of suspended users")
  ...
  public void setAllowUserReactivation(Boolean allowUserReactivation) {
  ...
  public ImportUsersRequest operations(List<ImportOperation> operations) {
  ...
  public ImportUsersRequest addOperationsItem(ImportOperation operationsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"users.create\",\"users.update\"]", value = "Operations to be performed on the user list returned from the application")
  ...
  public ImportUsersRequest queryString(String queryString) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "", value = "Query string to filter and sort the user list returned from the application.  The supported filtering and sorting varies by application.  If no value is sent, all users are returned. **Example:** \"location=Chicago&department=IT\"Query string used to retrieve users from service")
   ...
   * @return the ImportUsersRequest instance itself
   */
  public ImportUsersRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowUserReactivation, importUsersRequest.allowUserReactivation) &&
        Objects.equals(this.operations, importUsersRequest.operations) &&
        Objects.equals(this.queryString, importUsersRequest.queryString)&&
        Objects.equals(this.additionalProperties, importUsersRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowUserReactivation, operations, queryString, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    allowUserReactivation: ").append(toIndentedString(allowUserReactivation)).append("\n");
  ...
  static {
    ...
    openapiFields.add("allowUserReactivation");
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ImportUsersRequest>() {
           ...
           public ImportUsersRequest read(JsonReader in) throws IOException {
             ...
             ImportUsersRequest instance = thisAdapter.fromJsonTree(jsonObj);
