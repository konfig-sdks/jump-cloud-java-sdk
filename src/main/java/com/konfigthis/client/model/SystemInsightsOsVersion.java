...
public class SystemInsightsOsVersion {
  ...
  public static final String SERIALIZED_NAME_PLATFORM_LIKE = "platform_like";
  @SerializedName(SERIALIZED_NAME_PLATFORM_LIKE)
  ...
  **/
  ...
  @ApiModelProperty(example = "10.13.6", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "17G65", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2019-06-03T19:41:30.933Z", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Mac OS X", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "darwin", value = "")
  ...
  **/
   ...
   * @return the SystemInsightsOsVersion instance itself
   */
  public SystemInsightsOsVersion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, systemInsightsOsVersion.version) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsOsVersion.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, build, codename, collectionTime, installDate, major, minor, name, patch, platform, platformLike, systemId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("platform_like");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsOsVersion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsOsVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsOsVersion is not found in the empty JSON string", SystemInsightsOsVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("platform_like") != null && !jsonObj.get("platform_like").isJsonNull()) && !jsonObj.get("platform_like").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `platform_like` to be a primitive type in the JSON string but got `%s`", jsonObj.get("platform_like").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsOsVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsOsVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsOsVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsOsVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsOsVersion>() {
           @Override
           public void write(JsonWriter out, SystemInsightsOsVersion value) throws IOException {
           ...
           @Override
           public SystemInsightsOsVersion read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsOsVersion instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsOsVersion given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsOsVersion
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsOsVersion
  */
  public static SystemInsightsOsVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsOsVersion.class);
  }

 /**
  * Convert an instance of SystemInsightsOsVersion to an JSON string
  *
  * @return JSON string
  */
