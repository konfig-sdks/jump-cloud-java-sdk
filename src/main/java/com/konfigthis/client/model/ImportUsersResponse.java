...
import com.konfigthis.client.model.ImportUser;
...
public class ImportUsersResponse {
  ...
  public ImportUsersResponse totalCount(Double totalCount) {
  ...
  public ImportUsersResponse totalCount(Integer totalCount) {
  ...
  **/
   ...
   * @return the ImportUsersResponse instance itself
   */
  public ImportUsersResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalCount, importUsersResponse.totalCount) &&
        ...
        Objects.equals(this.additionalProperties, importUsersResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totalCount, users, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ImportUsersResponse>() {
           ...
           public ImportUsersResponse read(JsonReader in) throws IOException {
             ...
             ImportUsersResponse instance = thisAdapter.fromJsonTree(jsonObj);
