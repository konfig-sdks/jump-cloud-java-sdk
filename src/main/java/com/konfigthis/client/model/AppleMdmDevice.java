...
import com.konfigthis.client.model.AppleMdmDeviceInfo;
import com.konfigthis.client.model.AppleMdmDeviceSecurityInfo;
...
public class AppleMdmDevice {
  ...
  public static final String SERIALIZED_NAME_DEP_REGISTERED = "depRegistered";
  @SerializedName(SERIALIZED_NAME_DEP_REGISTERED)
  private Boolean depRegistered;
  ...
  private AppleMdmDeviceInfo deviceInformation;

  public static final String SERIALIZED_NAME_ENROLLED = "enrolled";
  @SerializedName(SERIALIZED_NAME_ENROLLED)
  private Boolean enrolled;

  public static final String SERIALIZED_NAME_HAS_ACTIVATION_LOCK_BYPASS_CODES = "hasActivationLockBypassCodes";
  @SerializedName(SERIALIZED_NAME_HAS_ACTIVATION_LOCK_BYPASS_CODES)
  private Boolean hasActivationLockBypassCodes;
  ...
  public static final String SERIALIZED_NAME_SECURITY_INFO = "securityInfo";
  @SerializedName(SERIALIZED_NAME_SECURITY_INFO)
  private AppleMdmDeviceSecurityInfo securityInfo;
  ...
  **/
  ...
  public Boolean getDepRegistered() {
    return depRegistered;
  }
  ...
  **/
  ...
  public Boolean getHasActivationLockBypassCodes() {
    return hasActivationLockBypassCodes;
  }
  ...
  **/
   ...
   * @return the AppleMdmDevice instance itself
   */
  public AppleMdmDevice putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, appleMdmDevice.createdAt) &&
        ...
        Objects.equals(this.additionalProperties, appleMdmDevice.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, depRegistered, deviceInformation, enrolled, hasActivationLockBypassCodes, id, osVersion, securityInfo, serialNumber, udid, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("depRegistered");
    openapiFields.add("deviceInformation");
    openapiFields.add("enrolled");
    openapiFields.add("hasActivationLockBypassCodes");
    openapiFields.add("id");
    openapiFields.add("osVersion");
    openapiFields.add("securityInfo");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppleMdmDevice
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppleMdmDevice.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppleMdmDevice is not found in the empty JSON string", AppleMdmDevice.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("createdAt") != null && !jsonObj.get("createdAt").isJsonNull()) && !jsonObj.get("createdAt").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `createdAt` to be a primitive type in the JSON string but got `%s`", jsonObj.get("createdAt").toString()));
      }
      // validate the optional field `deviceInformation`
      if (jsonObj.get("deviceInformation") != null && !jsonObj.get("deviceInformation").isJsonNull()) {
        AppleMdmDeviceInfo.validateJsonObject(jsonObj.getAsJsonObject("deviceInformation"));
      }
      ...
      // validate the optional field `securityInfo`
      if (jsonObj.get("securityInfo") != null && !jsonObj.get("securityInfo").isJsonNull()) {
        AppleMdmDeviceSecurityInfo.validateJsonObject(jsonObj.getAsJsonObject("securityInfo"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppleMdmDevice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppleMdmDevice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppleMdmDevice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppleMdmDevice.class));

       return (TypeAdapter<T>) new TypeAdapter<AppleMdmDevice>() {
           @Override
           public void write(JsonWriter out, AppleMdmDevice value) throws IOException {
           ...
           @Override
           public AppleMdmDevice read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppleMdmDevice instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppleMdmDevice given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppleMdmDevice
  * @throws IOException if the JSON string is invalid with respect to AppleMdmDevice
  */
  public static AppleMdmDevice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppleMdmDevice.class);
  }

 /**
  * Convert an instance of AppleMdmDevice to an JSON string
  *
  * @return JSON string
  */
