...
public class User {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addresses, alternateEmail, company, costCenter, department, email, employeeIdentifier, employeeType, firstname, jobTitle, lastname, location, phoneNumbers, additionalProperties);
  }
