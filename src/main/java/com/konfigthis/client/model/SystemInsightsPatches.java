...
public class SystemInsightsPatches {
  ...
  public static final String SERIALIZED_NAME_CSNAME = "csname";
  @SerializedName(SERIALIZED_NAME_CSNAME)
  private String csname;

  public static final String SERIALIZED_NAME_FIX_COMMENTS = "fix_comments";
  @SerializedName(SERIALIZED_NAME_FIX_COMMENTS)
  private String fixComments;

  public static final String SERIALIZED_NAME_HOTFIX_ID = "hotfix_id";
  @SerializedName(SERIALIZED_NAME_HOTFIX_ID)
  ...
  public static final String SERIALIZED_NAME_INSTALLED_BY = "installed_by";
  @SerializedName(SERIALIZED_NAME_INSTALLED_BY)
  ...
  **/
  ...
  @ApiModelProperty(example = "Security Update", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "http://support.microsoft.com/?kbid=4503308", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "DESKTOP-B17DUKP", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "KB4503308", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "NT AUTHORITY\\SYSTEM", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "7/30/2019", value = "")
  ...
  **/
   ...
   * @return the SystemInsightsPatches instance itself
   */
  public SystemInsightsPatches putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, systemInsightsPatches.description) &&
        Objects.equals(this.caption, systemInsightsPatches.caption) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsPatches.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, caption, collectionTime, csname, fixComments, hotfixId, installDate, installedBy, installedOn, systemId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("csname");
    openapiFields.add("fix_comments");
    openapiFields.add("hotfix_id");
    openapiFields.add("install_date");
    openapiFields.add("installed_by");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsPatches
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsPatches.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsPatches is not found in the empty JSON string", SystemInsightsPatches.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("csname") != null && !jsonObj.get("csname").isJsonNull()) && !jsonObj.get("csname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `csname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("csname").toString()));
      }
      if ((jsonObj.get("fix_comments") != null && !jsonObj.get("fix_comments").isJsonNull()) && !jsonObj.get("fix_comments").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `fix_comments` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fix_comments").toString()));
      }
      if ((jsonObj.get("hotfix_id") != null && !jsonObj.get("hotfix_id").isJsonNull()) && !jsonObj.get("hotfix_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `hotfix_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hotfix_id").toString()));
      }
      ...
      if ((jsonObj.get("installed_by") != null && !jsonObj.get("installed_by").isJsonNull()) && !jsonObj.get("installed_by").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `installed_by` to be a primitive type in the JSON string but got `%s`", jsonObj.get("installed_by").toString()));
      }
      if ((jsonObj.get("installed_on") != null && !jsonObj.get("installed_on").isJsonNull()) && !jsonObj.get("installed_on").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsPatches.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsPatches' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsPatches> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsPatches.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsPatches>() {
           @Override
           public void write(JsonWriter out, SystemInsightsPatches value) throws IOException {
           ...
           @Override
           public SystemInsightsPatches read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsPatches instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsPatches given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsPatches
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsPatches
  */
  public static SystemInsightsPatches fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsPatches.class);
  }

 /**
  * Convert an instance of SystemInsightsPatches to an JSON string
  *
  * @return JSON string
  */
