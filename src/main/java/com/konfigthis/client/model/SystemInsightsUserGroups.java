...
public class SystemInsightsUserGroups {
  ...
  **/
   ...
   * @return the SystemInsightsUserGroups instance itself
   */
  public SystemInsightsUserGroups putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.collectionTime, systemInsightsUserGroups.collectionTime) &&
        ...
        Objects.equals(this.additionalProperties, systemInsightsUserGroups.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionTime, gid, systemId, uid, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SystemInsightsUserGroups
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SystemInsightsUserGroups.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemInsightsUserGroups is not found in the empty JSON string", SystemInsightsUserGroups.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemInsightsUserGroups.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemInsightsUserGroups' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemInsightsUserGroups> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemInsightsUserGroups.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemInsightsUserGroups>() {
           @Override
           public void write(JsonWriter out, SystemInsightsUserGroups value) throws IOException {
           ...
           @Override
           public SystemInsightsUserGroups read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SystemInsightsUserGroups instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SystemInsightsUserGroups given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SystemInsightsUserGroups
  * @throws IOException if the JSON string is invalid with respect to SystemInsightsUserGroups
  */
  public static SystemInsightsUserGroups fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemInsightsUserGroups.class);
  }

 /**
  * Convert an instance of SystemInsightsUserGroups to an JSON string
  *
  * @return JSON string
  */
