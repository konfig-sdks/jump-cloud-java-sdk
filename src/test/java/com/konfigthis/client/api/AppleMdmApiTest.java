...
public class AppleMdmApiTest {
    ...
    private static AppleMdmApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new AppleMdmApi(apiClient);
    }
     ...
     */
    @Test
    public void csrgetTest() throws ApiException {
        String appleMdmId = null;
        String xOrgId = null;
        String response = api.csrget(appleMdmId)
                .xOrgId(xOrgId)
                .execute();
    ...
    public void deleteTest() throws ApiException {
        String id = null;
        String xOrgId = null;
        AppleMDM response = api.delete(id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void deletedeviceTest() throws ApiException {
        ...
        String xOrgId = null;
        AppleMdmDevice response = api.deletedevice(appleMdmId, deviceId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void depkeygetTest() throws ApiException {
        String appleMdmId = null;
        String xOrgId = null;
        String response = api.depkeyget(appleMdmId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void devicesClearActivationLockTest() throws ApiException {
        String appleMdmId = null;
        String deviceId = null;
        String xOrgId = null;
        api.devicesClearActivationLock(appleMdmId, deviceId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void devicesOSUpdateStatusTest() throws ApiException {
        String appleMdmId = null;
        String deviceId = null;
        String xOrgId = null;
        api.devicesOSUpdateStatus(appleMdmId, deviceId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void devicesRefreshActivationLockInformationTest() throws ApiException {
        String appleMdmId = null;
        String deviceId = null;
        String xOrgId = null;
        api.devicesRefreshActivationLockInformation(appleMdmId, deviceId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void devicesScheduleOSUpdateTest() throws ApiException {
        InstallActionType installAction = null;
        String productKey = null;
        String appleMdmId = null;
        String deviceId = null;
        Integer maxUserDeferrals = null;
        String xOrgId = null;
        api.devicesScheduleOSUpdate(installAction, productKey, appleMdmId, deviceId)
     ...
     */
    @Test
    public void deviceseraseTest() throws ApiException {
        String appleMdmId = null;
        String deviceId = null;
        String pin = null;
        String xOrgId = null;
        api.deviceserase(appleMdmId, deviceId)
                .pin(pin)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    ...
    public void deviceslistTest() throws ApiException {
        ...
        List<AppleMdmDevice> response = api.deviceslist(appleMdmId)
                .limit(limit)
                .xOrgId(xOrgId)
                .skip(skip)
                .filter(filter)
     ...
     */
    @Test
    public void deviceslockTest() throws ApiException {
        String appleMdmId = null;
        String deviceId = null;
        String pin = null;
        String xOrgId = null;
        api.deviceslock(appleMdmId, deviceId)
                .pin(pin)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void devicesrestartTest() throws ApiException {
        String appleMdmId = null;
        String deviceId = null;
        List<String> kextPaths = null;
        String xOrgId = null;
        api.devicesrestart(appleMdmId, deviceId)
                .kextPaths(kextPaths)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void devicesshutdownTest() throws ApiException {
        String appleMdmId = null;
        String deviceId = null;
        String xOrgId = null;
        api.devicesshutdown(appleMdmId, deviceId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void enrollmentprofilesgetTest() throws ApiException {
        ...
        String id = null;
        String xOrgId = null;
        String response = api.enrollmentprofilesget(appleMdmId, id)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void enrollmentprofileslistTest() throws ApiException {
        String appleMdmId = null;
        String xOrgId = null;
        List<AppleMDM> response = api.enrollmentprofileslist(appleMdmId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getdeviceTest() throws ApiException {
        ...
        String deviceId = null;
        String xOrgId = null;
        AppleMdmDevice response = api.getdevice(appleMdmId, deviceId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        Integer skip = null;
        List<String> filter = null;
        List<AppleMDM> response = api.list()
                .xOrgId(xOrgId)
                .limit(limit)
                .skip(skip)
                .filter(filter)
    ...
    public void putTest() throws ApiException {
        String id = null;
        ADES ades = null;
        Boolean allowMobileUserEnrollment = null;
        String appleCertCreatorAppleID = null;
        String appleSignedCert = null;
        String defaultIosUserEnrollmentDeviceGroupID = null;
        String defaultSystemGroupID = null;
        DEP dep = null;
        String encryptedDepServerToken = null;
        String name = null;
        String xOrgId = null;
        AppleMDM response = api.put(id)
                .ades(ades)
     ...
     */
    @Test
    public void refreshdepdevicesTest() throws ApiException {
        String appleMdmId = null;
        String xOrgId = null;
        api.refreshdepdevices(appleMdmId)
                .xOrgId(xOrgId)
                .execute();
        // TODO: test validations
    }
