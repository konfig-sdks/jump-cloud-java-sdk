...
public class PolicyTemplateWithDetails {
  ...
  **/
   ...
   * @return the PolicyTemplateWithDetails instance itself
   */
  public PolicyTemplateWithDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, policyTemplateWithDetails.description) &&
        ...
        Objects.equals(this.additionalProperties, policyTemplateWithDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, activation, behavior, configFields, displayName, id, name, osMetaFamily, osRestrictions, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PolicyTemplateWithDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PolicyTemplateWithDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyTemplateWithDetails is not found in the empty JSON string", PolicyTemplateWithDetails.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyTemplateWithDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyTemplateWithDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyTemplateWithDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyTemplateWithDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyTemplateWithDetails>() {
           @Override
           public void write(JsonWriter out, PolicyTemplateWithDetails value) throws IOException {
           ...
           @Override
           public PolicyTemplateWithDetails read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PolicyTemplateWithDetails instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PolicyTemplateWithDetails given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PolicyTemplateWithDetails
  * @throws IOException if the JSON string is invalid with respect to PolicyTemplateWithDetails
  */
  public static PolicyTemplateWithDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyTemplateWithDetails.class);
  }

 /**
  * Convert an instance of PolicyTemplateWithDetails to an JSON string
  *
  * @return JSON string
  */
