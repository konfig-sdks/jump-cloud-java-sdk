...
public class JobId {
  ...
  **/
   ...
   * @return the JobId instance itself
   */
  public JobId putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.jobId, jobId.jobId)&&
        Objects.equals(this.additionalProperties, jobId.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JobId>() {
           ...
           public JobId read(JsonReader in) throws IOException {
             ...
             JobId instance = thisAdapter.fromJsonTree(jsonObj);
