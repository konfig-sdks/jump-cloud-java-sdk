...
public class IpListsApiTest {
    ...
    private static IpListsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new IpListsApi(apiClient);
    }
